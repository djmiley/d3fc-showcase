...
!function(a,b){"object"==typeof exports&&"undefined"!=typeof module?b(require("d3")):"function"==typeof define&&define.amd?define(["d3"],b):b(a.d3)}(this,function(a){"use strict";function b(a,b){return b={exports:{}},a(b,b.exports),b.exports}function c(){return{messages:[]}}function d(){return++Dc}function e(a,b){function c(b){return a.secondaries.filter(function(a,c){return c===b})}for(var d=0,e=0;e<b.secondaries.length;e++)b.secondaries[e]&&d++;a.secondaries.filter(function(a,b){return d>b}).style("flex","1"),a.secondaries.filter(function(a,b){return b>=d}).style("flex","0"),a.overlaySecondaries.filter(function(a,b){return d>b}).style("flex","1"),a.overlaySecondaries.filter(function(a,b){return b>=d}).style("flex","0");var f=parseInt(a.app.select(".head-row").style("height"),10);Ec||(f+=parseInt(a.app.select(".head-row").style("padding-top"),10)+parseInt(a.app.select(".head-row").style("padding-bottom"),10)+parseInt(a.app.select(".head-row").style("margin-bottom"),10),Ec=!0);var g=window.innerHeight-f;a.charts.style("height",g+"px"),b.xAxis.dimensionChanged(a.xAxis),b.navbar.dimensionChanged(a.navbar),b.primary.dimensionChanged(a.primary);for(var h=0;h<b.secondaries.length;h++)b.secondaries[h].option.dimensionChanged(c(h))}function f(b,c){var d=a.max(b,function(a){return a.getTime()}),e=a.max(c,function(a){return a.date.getTime()});return d===e}function g(a,b){var c=Array.isArray(b)?b:[b,b],d=a[1]-a[0];return[a[0]-d*c[0],a[1]+d*c[1]]}/**
...
s(b-d/2,c-e,d,e)]}function s(a,b,c,d){return{x:a,y:b,width:c,height:d}}function t(a){return a[u(a)]}function u(a){return Math.floor(Math.random()*a.length)}function v(a,b,c){var d=a.slice();return d[b]=c,d}function w(){function b(a,b){
// For one point choose a random other placement.
var c=u(a),d=a[c],e=r(d),f=t(e);return v(b,c,f)}function c(a){for(var b=p(a),c=1,e=0;e<a.length;e++){var f=a[e];c+=d(f)?0:100}return b*c}var d=q(),e=1e3,f=1,g=function(a){for(var d=a,g=a,h=1/0,i=e;i>0;){var j=b(d,g),k=c(j),l=Math.exp((h-k)/i);(h>k||l>Math.random())&&(g=j,h=k),i-=f}return g};return g.temperature=function(a){return arguments.length?(e=a,g):e},g.cooling=function(a){return arguments.length?(f=a,g):f},a.rebind(g,d,"containerWidth"),a.rebind(g,d,"containerHeight"),g}function x(){function b(a,b){
...
var e=r(a[d[1]]),f=e.map(function(a){return v(b,d[1],a)}),g=k(f,function(a){var b=o(a,d[1]),e=c(a[d[1]]);return b+(e?0:Number.MAX_VALUE)});b=g}),b}var c=q(),d=1,e=function(a){
// Keep going until there's no more iterations to do or
// the solution is a local minimum
for(var c=a,e=a,f=Number.MAX_VALUE,g=1/0,h=0;d>h&&g>f;)g=f,e=b(c,e),f=p(e),h++;return e};return e.iterations=function(a){return arguments.length?(d=a,e):d},a.rebind(e,c,"containerWidth"),a.rebind(e,c,"containerHeight"),e}function y(){function b(a,b){var c=a.slice();return c.push(b),c}function c(a){for(var b=p(a),c=!0,e=0;e<a.length&&c;e++){var f=a[e];c=d(f)}return b+(c?0:1/0)}var d=q(),e=function(a){var d=[];return a.forEach(function(a){var e=r(a),f=e.map(function(a){return b(d,a)});d=k(f,c)}),d};return a.rebind(e,d,"containerWidth"),a.rebind(e,d,"containerHeight"),e}function z(){var a=1,b=1,c=function(c){return c.map(function(c,d){var e=c.x,f=c.y;return e+c.width>a&&(e-=c.width),f+c.height>b&&(f-=c.height),{x:e,y:f}})};return c.containerWidth=function(b){return arguments.length?(a=b,c):a},c.containerHeight=function(a){return arguments.length?(b=a,c):b},c}function A(){return this}function B(a){return a}function C(a,b){return b}function D(a){}
// Wrapper around d3's selectAll/data data-join, which allows decoration of the result.
// This is achieved by appending the element to the enter selection before exposing it.
// A default transition of fade in/out is also implicitly added but can be modified.
function E(){var b="g",c=!1,d="g",e={},f=C,g=function(g,h){var i=h||B;
...
function H(a,b){F(a)?a.rangePoints(b,1):a.range(b)}
...
function I(b){var c=b.map(function(b){return a.functor(b)});return function(a,b){return c.map(function(c){return c(a,b)})}}function J(b){var c=a.functor([0,0]),d=function(a,b){return[a.x,a.y]},e=a.scale.identity(),f=a.scale.identity(),g=D,h=b||B,i=D,k=E().selector("g.rectangle").element("g").attr("class","rectangle"),l=function(a){var b=G(e),j=G(f);h.containerWidth&&h.containerWidth(Math.max(b[0],b[1])),h.containerHeight&&h.containerHeight(Math.max(j[0],j[1])),a.each(function(a,b){var e=k(this,a),f=a.map(function(a,b){var e=d(a,b),f=c(a,b);return{x:e[0],y:e[1],width:f[0],height:f[1]}}),j=h(f);
// offset each rectangle accordingly
e.attr("transform",function(a,b){var c=j[b];return"translate("+c.x+", "+c.y+")"}),
// set the anchor-point for each rectangle
a.forEach(function(a,b){var c=d(a,b),e=[c[0]-j[b].x,c[1]-j[b].y];g(a,b,e)}),
// set the layout width / height so that children can use SVG layout if required
e.attr({"layout-width":function(a,b){return f[b].width},"layout-height":function(a,b){return f[b].height}}),e.call(i)})};return j(l,h),l.size=function(a){return arguments.length?(c=I(a),l):c},l.position=function(a){return arguments.length?(d=I(a),l):d},l.anchor=function(a){return arguments.length?(g=a,l):g},l.xScale=function(a){return arguments.length?(e=a,l):e},l.yScale=function(a){return arguments.length?(f=a,l):f},l.component=function(a){return arguments.length?(i=a,l):i},l}/* global requestAnimationFrame:false */
// Debounce render to only occur once per frame
function K(a){var b=null;return function(){null==b&&(b=requestAnimationFrame(function(){b=null,a()}))}}function L(a,b){return function(a,b){return{x:a,y:b}}}function M(a,b,c,d,e,f){
// a default function that computes the distance between two points
return f=f||function(a,b,c,d){var e=a-c,f=b-d;return e*e+f*f},function(g,h){var i=e.map(function(e){var i=f(g,h,a(c(e)),b(d(e)));return[i,e]}).reduce(function(a,b){return a[0]>b[0]?b:a},[Number.MAX_VALUE,null])[1];return{datum:i,x:i?a(c(i)):g,y:i?b(d(i)):h}}}function N(a,b,c){return function(d,e){var f=a.xScale(),g=a.yScale(),h=a.xValue(),i=(a.yValue||a.yCloseValue).call(a);return M(f,g,h,i,b,c)(d,e)}}function O(a,b){function c(a,b,c,d){var e=a-c;return Math.abs(e)}return N(a,b,c)}function P(a,b){function c(a,b,c,d){var e=b-d;return Math.abs(e)}return N(a,b,c)}
// returns the width and height of the given element minus the padding.
function Q(a){var b=a.ownerDocument.defaultView.getComputedStyle(a);return{width:parseFloat(b.width)-parseFloat(b.paddingLeft)-parseFloat(b.paddingRight),height:parseFloat(b.height)-parseFloat(b.paddingTop)-parseFloat(b.paddingBottom)}}
...
// by the given factor
function R(b){return function(c){
...
var d=a.pairs(c).map(function(a){return Math.abs(a[0]-a[1])}),e=a.min(d);return b*e}}/**
   ...
   * @memberof fc.util
   */
function S(){var b=[],c=null,d="percent",e=0,f=null,g=function(g){
...
function Y(){var b=a.time.scale(),c=a.scale.linear(),d=[],e=A,f=C,g=D,h=E().selector("g.multi").children(!0).attr("class","multi").element("g").key(function(a,b){
...
a.selection.prototype.order.call(i),g(i)})};return i.xScale=function(a){return arguments.length?(b=a,i):b},i.yScale=function(a){return arguments.length?(c=a,i):c},i.series=function(a){return arguments.length?(d=a,i):d},i.mapping=function(a){return arguments.length?(e=a,i):e},i.key=function(a){return arguments.length?(f=a,i):f},i.decorate=function(a){return arguments.length?(g=a,i):g},i}function Z(){function b(){}var c=a.time.scale(),d=a.scale.linear(),e=a.functor(0),f=a.functor(0),g=function(a,b){return a.date},h=function(a,b){return a.close};return b.x0=function(a,b){return c(f(a,b))},b.y0=function(a,b){return d(e(a,b))},b.x=b.x1=function(a,b){return c(g(a,b))},b.y=b.y1=function(a,b){return d(h(a,b))},b.defined=function(a,b){return null!=f(a,b)&&null!=e(a,b)&&null!=g(a,b)&&null!=h(a,b)},b.xScale=function(a){return arguments.length?(c=a,b):c},b.yScale=function(a){return arguments.length?(d=a,b):d},b.x0Value=function(c){return arguments.length?(f=a.functor(c),b):f},b.y0Value=function(c){return arguments.length?(e=a.functor(c),b):e},b.xValue=b.x1Value=function(c){return arguments.length?(g=a.functor(c),b):g},b.yValue=b.y1Value=function(c){return arguments.length?(h=a.functor(c),b):h},b}function $(){var b=D,c=a.svg.symbol(),d=Z(),e=E().selector("g.point").element("g").attr("class","point"),f=function(a,b){return"translate("+d.x(a,b)+", "+d.y(a,b)+")"},g=function(a){a.each(function(a,g){var h=a.filter(d.defined),i=e(this,h);i.enter().attr("transform",f).append("path"),i.attr("transform",f).select("path").attr("d",c),b(i,a,g)})};return g.decorate=function(a){return arguments.length?(b=a,g):b},a.rebind(g,d,"xScale","xValue","yScale","yValue"),a.rebind(g,e,"key"),a.rebind(g,c,"size","type"),g}function _(){
...
// these annotations.
function b(b){return a.scale.identity().range(G(b))}function c(){var b=a.mouse(this),c=a.select(this),d=j.apply(this,b),e=c.datum();e.push(d),c.call(r),f.trackingstart.apply(this,arguments)}function d(){var b=a.mouse(this),c=a.select(this),d=j.apply(this,b),e=c.datum();e[e.length-1]=d,c.call(r),f.trackingmove.apply(this,arguments)}function e(){var b=a.select(this),c=b.datum();c.pop(),b.call(r),f.trackingend.apply(this,arguments)}var f=a.dispatch("trackingstart","trackingmove","trackingend"),g=a.time.scale(),i=a.scale.linear(),j=function(a,b){return L(g,i)(a,b)},k=D,l=function(a){return a.x},m=function(a){return a.y},n=E().children(!0).selector("g.crosshair").element("g").attr("class","crosshair"),o=$().xValue(l).yValue(m),p=X().value(m).label(function(a){return a.y}),q=X().orient("vertical").value(l).label(function(a){return a.x}),r=function(f){f.each(function(f,h){var j=a.select(this).style("pointer-events","all").on("mouseenter.crosshair",c).on("mousemove.crosshair",d).on("mouseleave.crosshair",e),l=j.selectAll("rect").data([f]);l.enter().append("rect").style("visibility","hidden"),j.select("rect").attr("x",G(g)[0]).attr("y",G(i)[1]).attr("width",G(g)[1]).attr("height",G(i)[0]);var m=n(j,f);m.enter().style("pointer-events","none");var r=Y().series([p,q,o]).xScale(b(g)).yScale(b(i)).mapping(function(){return[this]});m.call(r),k(m,f,h)})};return r.xScale=function(a){return arguments.length?(g=a,r):g},r.yScale=function(a){return arguments.length?(i=a,r):i},r.snap=function(a){return arguments.length?(j=a,r):j},r.decorate=function(a){return arguments.length?(k=a,r):k},a.rebind(r,f,"on"),h(r,p,{yLabel:"label"}),h(r,q,{xLabel:"label"}),r}
// Renders an error bar series as an SVG path based on the given array of datapoints.
function aa(){var b=function(a,b){return a.x},c=function(a,b){return a.y},d=function(a,b){return a.errorHigh},e=function(a,b){return a.errorLow},f="vertical",g=a.functor(5),h=function(a){return a.map(function(a,h){var i=g(a,h)/2,j=d(a,h)-e(a,h),k=c(a,h)-e(a,h),l=d(a,h)-c(a,h),m=b(a,h)-e(a,h),n=d(a,h)-b(a,h),o="",p="";if("vertical"===f){var q="h"+-i+"h"+2*i+"h"+-i,r="v"+-j;o="M0,"+k+q+r+q+"M0,"+l}else{var s="v"+-i+"v"+2*i+"v"+-i,t="h"+-j;p="M"+m+",0"+s+t+s+"M"+n+",0"}return o+p}).join("")};return h.x=function(c){return arguments.length?(b=a.functor(c),h):b},h.y=function(b){return arguments.length?(c=a.functor(b),h):c},h.errorHigh=function(b){return arguments.length?(d=a.functor(b),h):d},h.errorLow=function(b){return arguments.length?(e=a.functor(b),h):e},h.barWidth=function(b){return arguments.length?(g=a.functor(b),h):g},h.orient=function(a){return arguments.length?(f=a,h):f},h}
// Renders an OHLC as an SVG path based on the given array of datapoints. Each
// OHLC has a fixed width, whilst the x, open, high, low and close positions are
// obtained from each point via the supplied accessor functions.
function ba(){var b=function(a,b){return a.date},c=function(a,b){return a.open},d=function(a,b){return a.high},e=function(a,b){return a.low},f=function(a,b){return a.close},g=a.functor(3),h=function(a){return a.map(function(a,h){var i=b(a,h),j=c(a,h),k=d(a,h),l=e(a,h),m=f(a,h),n=g(a,h)/2,o="M"+i+","+l,p="V"+k,q="M"+i+","+j+"h"+-n,r="M"+i+","+m+"h"+n;return o+p+q+r}).join("")};return h.x=function(c){return arguments.length?(b=a.functor(c),h):b},h.open=function(b){return arguments.length?(c=a.functor(b),h):c},h.high=function(b){return arguments.length?(d=a.functor(b),h):d},h.low=function(b){return arguments.length?(e=a.functor(b),h):e},h.close=function(b){return arguments.length?(f=a.functor(b),h):f},h.width=function(b){return arguments.length?(g=a.functor(b),h):g},h}
...
// obtained from each point via the supplied accessor functions.
function ca(){var b=function(a,b){return a.date},c=function(a,b){return a.open},d=function(a,b){return a.high},e=function(a,b){return a.low},f=function(a,b){return a.close},g=a.functor(3),h=function(a){return a.map(function(a,h){var i=b(a,h),j=c(a,h),k=d(a,h),l=e(a,h),m=f(a,h),n=g(a,h),o="M"+(i-n/2)+","+j+
// Draw the width
"h"+n+
...
// the bound data
function b(a,b){return function(c){return b(a(c),0)}}function c(a,b){return e()?"translate("+b+", "+a+")":"translate("+a+", "+b+")"}function d(a){return e()?a.map(function(a){return[a[1],a[0]]}):a}function e(){return"left"===i||"right"===i}function f(a,b){return g[a]?g[a].apply(g,j):b}var g=a.scale.identity(),h=D,i="bottom",j=[10],k=null,l=null,m=6,n=6,o=3,p=a.svg.line(),q=E().selector("g.tick").element("g").key(B).attr("class","tick"),r=E().selector("path.domain").element("path").attr("class","domain"),s=function(e){e.each(function(e,j){
// Stash a snapshot of the new scale, and retrieve the old snapshot.
var s=this.__chart__||g;this.__chart__=g.copy();var t=null==k?f("ticks",g.domain()):k,u=null==l?f("tickFormat",B):l,v="bottom"===i||"right"===i?1:-1,w=a.select(this),x=G(g),y=d([[x[0],v*m],[x[0],0],[x[1],0],[x[1],v*m]]),z=r(w,[e]);z.attr("d",p(y)),
...
transform:b(F(g)?g:s,c)});var A=q(w,t);
// enter
A.enter().append("path");var C=v*(n+o);A.enter().append("text").attr("transform",c(0,C)),
// update
A.attr("class","tick orient-"+i),A.attr("transform",b(g,c)),A.selectAll("path").attr("d",function(a){return p(d([[0,0],[0,v*n]]))}),A.selectAll("text").attr("transform",c(0,C)).text(u),
// exit - for non ordinal scales, exit by animating the tick to its new location
F(g)||A.exit().attr("transform",b(g,c)),h(A,e,j)})};return s.scale=function(a){return arguments.length?(g=a,s):g},s.ticks=function(a){return arguments.length?(j=arguments,s):j},s.tickValues=function(a){return arguments.length?(k=a,s):k},s.tickFormat=function(a){return arguments.length?(l=a,s):l},s.tickSize=function(a){var b=arguments.length;return b?(n=Number(a),m=Number(arguments[b-1]),s):n},s.innerTickSize=function(a){return arguments.length?(n=Number(a),s):n},s.outerTickSize=function(a){return arguments.length?(m=Number(a),s):m},s.tickPadding=function(a){return arguments.length?(o=a,s):o},s.orient=function(a){return arguments.length?(i=a,s):i},s.decorate=function(a){return arguments.length?(h=a,s):h},s}function fa(){var a="",b=function(a){return a.y},c=!1,d=function(a,b,c){return b===c.length-1?"Final":void 0},e={up:"up",down:"down",unchanged:"unchanged"},f=function(f){var g,h,i,j=f.length,k=0,l=0,m=[];for(c&&(l=b(f[0]),m.push({x:f[0][a],y0:0,y1:l,direction:e.unchanged}),k=1),k;j>k;k+=1)g=l,h=b(f[k])+l,m.push({x:f[k][a],y0:g,y1:h,direction:h-g>0?e.up:e.down}),i=d(f[k],k,f),i&&m.push({x:i,y0:0,y1:h,direction:e.unchanged}),l=h;return m};return f.xValueKey=function(b){return arguments.length?(a=b,f):a},f.yValue=function(a){return arguments.length?(b=a,f):b},f.total=function(a){return arguments.length?(d=a,f):d},f.startsWithTotal=function(a){return arguments.length?(c=a,f):c},f}
...
function ga(){function b(a,b){return"vertical"===i?"translate("+k.x1(a,b)+", "+k.y0(a,b)+")":"translate("+k.x0(a,b)+", "+k.y1(a,b)+")"}function c(a,b){return"vertical"===i?k.y1(a,b)-k.y0(a,b):k.x1(a,b)-k.x0(a,b)}function d(a){return"vertical"===i?a.height:a.width}function e(a){return"vertical"===i?a.width:a.height}function f(){return"vertical"===i?k.x:k.y}var g=D,h=R(.75),i="vertical",j=da(),k=Z().xValue(function(a,b){return"vertical"===i?a.date:a.close}).yValue(function(a,b){return"vertical"===i?a.close:a.date}),l=E().selector("g.bar").element("g"),m=function(a){a.each(function(a,m){if("vertical"!==i&&"horizontal"!==i)throw new Error("The bar series does not support an orientation of "+i);l.attr("class","bar "+i);var n=a.filter(k.defined);j.x(0).y(0).width(0).height(0),"vertical"===i?j.verticalAlign("top"):j.horizontalAlign("right");
...
d(j)(c),p.attr("transform",b).select("path").attr("d",function(a){return j([a])}),g(p,n,m)})};return m.decorate=function(a){return arguments.length?(g=a,m):g},m.barWidth=function(b){return arguments.length?(h=a.functor(b),m):h},m.orient=function(a){return arguments.length?(i=a,m):i},a.rebind(m,k,"xScale","xValue","x1Value","x0Value","yScale","yValue","y1Value","y0Value"),a.rebind(m,l,"key"),m}function ha(){function a(){return"vertical"===b.orient()}var b=ga(),c=function(c){b.xValue(function(b,c){return a()?b.x:b.y1}).yValue(function(b,c){return a()?b.y1:b.x}).x0Value(function(b,c){return a()?0:b.y0}).y0Value(function(b,c){return a()?b.y0:0}).decorate(function(a,c,d){a.enter().attr("class","waterfall "+b.orient()).classed("up",function(a){return"up"===a.direction}).classed("down",function(a){return"down"===a.direction})}),b(c)};return j(c,b),c}function ia(){function b(){}var c=a.time.scale(),d=a.scale.linear(),e=a.functor(0),f=a.functor(0),g=function(a,b){return a.date},h=function(a,b){return a.close},i="vertical",j=a.functor(5);return b.width=function(a,b){return j("vertical"===b?a.map(function(a,b){return c(g(a,b))}):a.map(function(a,b){return d(h(a,b))}))},b.values=function(a,b){return"vertical"===i?{x:c(g(a,b)),y:d(h(a,b)),errorHigh:d(e(a,b)),errorLow:d(f(a,b))}:{x:c(g(a,b)),y:d(h(a,b)),errorHigh:c(e(a,b)),errorLow:c(f(a,b))}},b.defined=function(a,b){return null!=f(a,b)&&null!=e(a,b)&&null!=g(a,b)&&null!=h(a,b)},b.orient=function(a){return arguments.length?(i=a,b):i},b.xScale=function(a){return arguments.length?(c=a,b):c},b.yScale=function(a){return arguments.length?(d=a,b):d},b.errorLow=function(c){return arguments.length?(f=a.functor(c),b):f},b.errorHigh=function(c){return arguments.length?(e=a.functor(c),b):e},b.xValue=function(c){return arguments.length?(g=a.functor(c),b):g},b.yValue=function(c){return arguments.length?(h=a.functor(c),b):h},b.barWidth=function(c){return arguments.length?(j=a.functor(c),b):j},b}function ja(){var b=D,c=5,d="vertical",e=ia(),f=E().selector("g.errorBar").element("g").attr("class","errorBar"),g=function(c){e.orient(g.orient()),c.each(function(c,d){var h=c.filter(e.defined),i=f(this,h);i.enter().append("path");var j=aa().orient(g.orient()).barWidth(e.width(h));i.each(function(b,c){var d=e.values(b,c),f=a.select(this).attr("transform","translate("+d.x+", "+d.y+")");j.x(d.x).errorHigh(d.errorHigh).errorLow(d.errorLow).y(d.y),f.select("path").attr("d",j([b])).attr("stroke","black")}),b(i,c,d)})};return g.barWidth=function(a){return arguments.length?(c=a,g):c},g.orient=function(a){return arguments.length?(d=a,g):d},g.decorate=function(a){return arguments.length?(b=a,g):b},a.rebind(g,f,"key"),j(g,e),g}function ka(){function b(){}var c=a.time.scale(),d=a.scale.linear(),e=function(a,b){return a.date},f=function(a,b){return a.open},g=function(a,b){return a.high},h=function(a,b){return a.low},i=function(a,b){return a.close},j=R(.75),k=function(a,b){return c(e(a,b))};return b.width=function(a){return j(a.map(k))},b.defined=function(a,b){return null!=e(a,b)&&null!=f(a,b)&&null!=h(a,b)&&null!=g(a,b)&&null!=i(a,b)},b.values=function(a,b){var c=i(a,b),e=f(a,b),j="";return c>e?j="up":e>c&&(j="down"),{x:k(a,b),yOpen:d(e),yHigh:d(g(a,b)),yLow:d(h(a,b)),yClose:d(c),direction:j}},b.xScale=function(a){return arguments.length?(c=a,b):c},b.yScale=function(a){return arguments.length?(d=a,b):d},b.xValue=function(a){return arguments.length?(e=a,b):e},b.yOpenValue=function(a){return arguments.length?(f=a,b):f},b.yHighValue=function(a){return arguments.length?(g=a,b):g},b.yLowValue=function(a){return arguments.length?(h=a,b):h},b.yValue=b.yCloseValue=function(a){return arguments.length?(i=a,b):i},b.barWidth=function(c){return arguments.length?(j=a.functor(c),b):j},b}function la(){var b=ga(),c=R(.75),d=D,e=a.scale.linear(),f=a.scale.linear(),g=function(a){return a.values},h=E().selector("g.stacked").element("g").attr("class","stacked"),i=function(a,c){return e(b.xValue()(a,c))},j=function(j){j.each(function(j){var k=c(g(j[0]).map(i)),l=k/(j.length-1);b.barWidth(l);var m=k/2;f.domain([0,j.length-1]).range([-m,m]);var n=h(this,j);n.enter().append("g"),n.select("g").datum(g).each(function(c,g){var h=a.select(this),i=function(a){return e(a)+f(g)};b.xScale(i),
// adapt the decorate function to give each series the correct index
b.decorate(function(a,b){d(a,b,g)}),h.call(b)})})};return j.decorate=function(a){return arguments.length?(d=a,j):d},j.xScale=function(a){return arguments.length?(e=a,j):e},j.values=function(a){return arguments.length?(g=a,j):g},a.rebind(j,b,"yValue","xValue","yScale"),j}function ma(){var b=D,c=Z(),d=a.svg.line().defined(c.defined).x(c.x).y(c.y),e=E().selector("path.line").element("path").attr("class","line"),f=function(a){a.each(function(a,c){var f=e(this,[a]);f.attr("d",d),b(f,a,c)})};return f.decorate=function(a){return arguments.length?(b=a,f):b},a.rebind(f,c,"xScale","xValue","yScale","yValue"),a.rebind(f,e,"key"),a.rebind(f,d,"interpolate","tension"),f}function na(){var b=D,c=function(a){return a.values},d=function(d){d.each(function(d){var e=a.select(this),f=E().selector("g.stacked").element("g").attr("class","stacked"),g=f(e,d);g.enter().append("g"),g.select("g").datum(c).call(b)})};return d.series=function(a){return arguments.length?(b=a,d):b},d.values=function(a){return arguments.length?(c=a,d):c},d}function oa(){var a=ma().yValue(function(a){return a.y0+a.y}),b=na().series(a),c=function(a){a.call(b)};return j(c,a),c}function pa(){var a=ga().yValue(function(a){return a.y0+a.y}).y0Value(function(a){return a.y0}),b=na().series(a),c=function(a){a.call(b)};return j(c,a),c}function qa(){var b=D,c=Z(),d=a.svg.area().defined(c.defined).x(c.x).y0(c.y0).y1(c.y1),e=E().selector("path.area").element("path").attr("class","area"),f=function(a){a.each(function(a,c){var f=e(this,[a]);f.attr("d",d),b(f,a,c)})};return f.decorate=function(a){return arguments.length?(b=a,f):b},a.rebind(f,c,"xScale","xValue","yScale","yValue","y1Value","y0Value"),a.rebind(f,e,"key"),a.rebind(f,d,"interpolate","tension"),f}function ra(){var a=qa().yValue(function(a){return a.y0+a.y}).y0Value(function(a){return a.y0}),b=na().series(a),c=function(a){a.call(b)};return j(c,a),c}function sa(b){function c(a){return"translate("+a.x+", "+a.yHigh+")"}var d=D,e=ka(),f=E().selector("g.ohlc").element("g").attr("class","ohlc"),g=function(b){b.each(function(b,g){var h=b.filter(e.defined),i=f(this,h);i.enter().attr("transform",function(a,b){return c(e.values(a,b))+" scale(1e-6, 1)"}).append("path");var j=ba().width(e.width(h));i.each(function(b,d){var f=e.values(b,d),g=a.transition(a.select(this)).attr({"class":"ohlc "+f.direction,transform:function(){return c(f)+" scale(1)"}});j.x(a.functor(0)).open(function(){return f.yOpen-f.yHigh}).high(function(){return f.yHigh-f.yHigh}).low(function(){return f.yLow-f.yHigh}).close(function(){return f.yClose-f.yHigh}),g.select("path").attr("d",j([b]))}),d(i,b,g)})};return g.decorate=function(a){return arguments.length?(d=a,g):d},a.rebind(g,f,"key"),j(g,e),g}function ta(){var b=D,c=a.scale.linear(),d=a.scale.linear(),e=function(a,b){return a.date.getDay()},f=a.scale.linear(),g=ma(),h=R(.75),i=E().selector("g.cycle").element("g").attr("class","cycle"),j=function(j){j.each(function(j,k){var l=a.nest().key(e).map(j),m=Object.keys(l),n=h(m.map(c)),o=n/2,p=i(this,m);p.each(function(b,e){var h=a.select(this);h.attr("transform","translate("+c(b)+", 0)"),(f.rangeBands||f.range)([-o,o]),g.xScale(f).yScale(d),a.select(this).datum(l[b]).call(g)}),b(p,m,k)})};return j.decorate=function(a){return arguments.length?(b=a,j):b},j.xScale=function(a){return arguments.length?(c=a,j):c},j.yScale=function(a){return arguments.length?(d=a,j):d},j.xValue=function(a){return arguments.length?(e=a,j):e},j.subScale=function(a){return arguments.length?(f=a,j):f},j.subSeries=function(a){return arguments.length?(g=a,j):g},j.barWidth=function(b){return arguments.length?(h=a.functor(b),j):h},a.rebind(j,i,"key"),j}function ua(){function b(a){return"translate("+a.x+", "+a.yHigh+")"}var c=D,d=ka(),e=E().selector("g.candlestick").element("g").attr("class","candlestick"),f=function(f){f.each(function(f,g){var h=f.filter(d.defined),i=e(this,h);i.enter().attr("transform",function(a,c){return b(d.values(a,c))+" scale(1e-6, 1)"}).append("path");var j=ca().width(d.width(h));i.each(function(c,e){var f=d.values(c,e),g=a.transition(a.select(this)).attr({"class":"candlestick "+f.direction,transform:function(){return b(f)+" scale(1)"}});j.x(a.functor(0)).open(function(){return f.yOpen-f.yHigh}).high(function(){return f.yHigh-f.yHigh}).low(function(){return f.yLow-f.yHigh}).close(function(){return f.yClose-f.yHigh}),g.select("path").attr("d",j([c]))}),c(i,f,g)})};return f.decorate=function(a){return arguments.length?(c=a,f):c},a.rebind(f,e,"key"),j(f,d),f}
...
function va(){var b=ea(),c=a.functor(0),d=D,e=a.time.scale(),f=a.scale.linear(),g=E().selector("g.axis-adapter").element("g").attr({"class":"axis axis-adapter"}),h=function(a){a.each(function(a,i){var j,k=g(this,[a]);switch(h.orient()){case"top":case"bottom":j="translate(0,"+f(c(a))+")",b.scale(e);break;case"left":case"right":j="translate("+e(c(a))+",0)",b.scale(f);break;default:throw new Error("Invalid orientation")}k.enter().attr("transform",j),k.attr("transform",j),k.call(b),d(k,a,i)})};return h.baseline=function(b){return arguments.length?(c=a.functor(b),h):c},h.decorate=function(a){return arguments.length?(d=a,h):d},h.xScale=function(a){return arguments.length?(e=a,h):e},h.yScale=function(a){return arguments.length?(f=a,h):f},a.rebind(h,b,"orient","ticks","tickValues","tickSize","innerTickSize","outerTickSize","tickPadding","tickFormat")}function wa(){var a={};return a.distance=function(a,b){return b.getTime()-a.getTime()},a.offset=function(a,b){return new Date(a.getTime()+b)},a.clampUp=B,a.clampDown=B,a.copy=function(){return a},a}
// obtains the ticks from the given scale, transforming the result to ensure
// it does not include any discontinuities
function xa(a,b,c){var d=a.map(function(d,e){if(e<a.length-1)return b.clampUp(d);var f=b.clampUp(d);return f<c[1]?f:b.clampDown(d)}),e=d.reduce(function(a,b){return 0===a.filter(function(a){return a.getTime()===b.getTime()}).length&&a.push(b),a},[]);return e}/**
  ...
  */
function ya(b,c){function d(a){var d=b.domain(),e=b.range(),f=c.distance(d[0],d[1]),g=c.distance(d[0],a),h=g/f,i=h*(e[1]-e[0])+e[0];return i}return arguments.length||(b=a.time.scale(),c=wa()),d.invert=function(a){var d=b.domain(),e=b.range(),f=(a-e[0])/(e[1]-e[0]),g=c.distance(d[0],d[1]),h=f*g;return c.offset(d[0],h)},d.domain=function(a){if(!arguments.length)return b.domain();
// clamp the upper and lower domain values to ensure they
// do not fall within a discontinuity
var e=c.clampUp(a[0]),f=c.clampDown(a[1]);return b.domain([e,f]),d},d.nice=function(){b.nice();var a=b.domain(),e=c.clampUp(a[0]),f=c.clampDown(a[1]);return b.domain([e,f]),d},d.ticks=function(){var a=b.ticks.apply(this,arguments);return xa(a,c,d.domain())},d.copy=function(){return ya(b.copy(),c.copy())},d.discontinuityProvider=function(a){return arguments.length?(c=a,d):c},a.rebind(d,b,"range","rangeRound","interpolate","clamp","tickFormat")}function za(){return ya()}function Aa(){function b(a){return 0===a.getDay()||6===a.getDay()}var c=864e5,d=5*c,e=7*c,f={};
...
return g=a.time.day.offset(g,7*j),h-=j*d,g=new Date(g.getTime()+h)},f.copy=function(){return f},f}function Ba(){var b=a.time.scale(),c=a.scale.linear(),d=function(a){return a.date},e=function(a){return a.elderRay},f=ga(),g=ga(),h=ga(),i=ga(),j=Y(),k=D,l=function(a){function l(a,b){
// The values share parity and the input is smaller than the comparison
return a*b>0&&Math.abs(a)<Math.abs(b)}f.xValue(d).yValue(function(a,b){return l(e(a).bullPower,e(a).bearPower)?void 0:e(a).bullPower}),g.xValue(d).yValue(function(a,b){return l(e(a).bearPower,e(a).bullPower)?void 0:e(a).bearPower}),h.xValue(d).yValue(function(a,b){return l(e(a).bullPower,e(a).bearPower)?e(a).bullPower:void 0}),i.xValue(d).yValue(function(a,b){return l(e(a).bearPower,e(a).bullPower)?e(a).bearPower:void 0}),j.xScale(b).yScale(c).series([f,g,h,i]).decorate(function(a,b,c){a.enter().attr("class",function(a,b){return"multi "+["bull","bear","bull top","bear top"][b]}),k(a,b,c)}),a.call(j)};return l.xScale=function(a){return arguments.length?(b=a,l):b},l.xValue=function(a){return arguments.length?(d=a,l):d},l.yScale=function(a){return arguments.length?(c=a,l):c},l.decorate=function(a){return arguments.length?(k=a,l):k},l}function Ca(){var b=a.time.scale(),c=a.scale.linear(),d=function(a,b){return a.close},e=function(a,b){return a.date},f=function(a){return a.envelope},g=D,h=qa().y0Value(function(a,b){return f(a).upper}).y1Value(function(a,b){return f(a).lower}),i=ma().yValue(function(a,b){return f(a).upper}),j=ma().yValue(function(a,b){return f(a).lower}),k=function(a){var d=Y().xScale(b).yScale(c).series([h,i,j]).decorate(function(a,b,c){a.enter().attr("class",function(a,b){return"multi envelope "+["area","upper","lower"][b]}),g(a,b,c)});h.xValue(e),i.xValue(e),j.xValue(e),a.call(d)};return k.xScale=function(a){return arguments.length?(b=a,k):b},k.yScale=function(a){return arguments.length?(c=a,k):c},k.xValue=function(a){return arguments.length?(e=a,k):e},k.yValue=function(a){return arguments.length?(d=a,k):d},k.root=function(a){return arguments.length?(f=a,k):f},k.decorate=function(a){return arguments.length?(g=a,k):g},k}function Da(){var b=a.time.scale(),c=a.scale.linear(),d=Y(),e=D,f=X(),g=ma().yValue(function(a,b){return a.force}),h=function(a){d.xScale(b).yScale(c).series([f,g]).mapping(function(a){return a===f?[0]:this}).decorate(function(a,b,c){a.enter().attr("class",function(a,b){return"multi "+["annotations","indicator"][b]}),e(a,b,c)}),a.call(d)};return h.xScale=function(a){return arguments.length?(b=a,f.xScale(a),h):b},h.yScale=function(a){return arguments.length?(c=a,f.yScale(a),h):c},h.decorate=function(a){return arguments.length?(e=a,h):e},a.rebind(h,g,"yValue","xValue"),h}function Ea(){var b=a.time.scale(),c=a.scale.linear(),d=80,e=20,f=Y(),g=D,h=X(),i=ma().yValue(function(a,b){return a.stochastic.d}),j=ma().yValue(function(a,b){return a.stochastic.k}),k=function(a){f.xScale(b).yScale(c).series([h,i,j]).mapping(function(a){return a===h?[d,e]:this}).decorate(function(a,b,c){a.enter().attr("class",function(a,b){return"multi stochastic "+["annotations","stochastic-d","stochastic-k"][b]}),g(a,b,c)}),a.call(f)};return k.xScale=function(a){return arguments.length?(b=a,k):b},k.yScale=function(a){return arguments.length?(c=a,k):c},k.upperValue=function(a){return arguments.length?(d=a,k):d},k.lowerValue=function(a){return arguments.length?(e=a,k):e},k.decorate=function(a){return arguments.length?(g=a,k):g},a.rebind(k,i,"yDValue","xDValue"),a.rebind(k,j,"yKValue","xKValue"),k}function Fa(){var b=a.time.scale(),c=a.scale.linear(),d=70,e=30,f=Y(),g=D,h=X(),i=ma().yValue(function(a,b){return a.rsi}),j=function(a){f.xScale(b).yScale(c).series([i,h]).mapping(function(a){return a===h?[d,50,e]:this}).decorate(function(a,b,c){a.enter().attr("class",function(a,b){return"multi rsi "+["indicator","annotations"][b]}),g(a,b,c)}),a.call(f)};return j.xScale=function(a){return arguments.length?(b=a,j):b},j.yScale=function(a){return arguments.length?(c=a,j):c},j.upperValue=function(a){return arguments.length?(d=a,j):d},j.lowerValue=function(a){return arguments.length?(e=a,j):e},j.decorate=function(a){return arguments.length?(g=a,j):g},a.rebind(j,i,"yValue","xValue"),j}function Ga(){var b=a.time.scale(),c=a.scale.linear(),d=function(a){return a.date},e=function(a){return a.macd},f=ma(),g=ma(),h=ga(),i=Y(),j=D,k=function(a){f.xValue(d).yValue(function(a,b){return e(a).macd}),g.xValue(d).yValue(function(a,b){return e(a).signal}),h.xValue(d).yValue(function(a,b){return e(a).divergence}),i.xScale(b).yScale(c).series([h,f,g]).decorate(function(a,b,c){a.enter().attr("class",function(a,b){return"multi "+["macd-divergence","macd","macd-signal"][b]}),j(a,b,c)}),a.call(i)};return k.xScale=function(a){return arguments.length?(b=a,k):b},k.xValue=function(a){return arguments.length?(d=a,k):d},k.yScale=function(a){return arguments.length?(c=a,k):c},k.root=function(a){return arguments.length?(e=a,k):e},k.decorate=function(a){return arguments.length?(j=a,k):j},k}function Ha(){var b=a.time.scale(),c=a.scale.linear(),d=function(a,b){return a.close},e=function(a,b){return a.date},f=function(a){return a.bollingerBands},g=D,h=qa().y0Value(function(a,b){return f(a).upper}).y1Value(function(a,b){return f(a).lower}),i=ma().yValue(function(a,b){return f(a).upper}),j=ma().yValue(function(a,b){return f(a).average}),k=ma().yValue(function(a,b){return f(a).lower}),l=function(a){var d=Y().xScale(b).yScale(c).series([h,i,k,j]).decorate(function(a,b,c){a.enter().attr("class",function(a,b){return"multi bollinger "+["area","upper","lower","average"][b]}),g(a,b,c)});h.xValue(e),i.xValue(e),j.xValue(e),k.xValue(e),a.call(d)};return l.xScale=function(a){return arguments.length?(b=a,l):b},l.yScale=function(a){return arguments.length?(c=a,l):c},l.xValue=function(a){return arguments.length?(e=a,l):e},l.yValue=function(a){return arguments.length?(d=a,l):d},l.root=function(a){return arguments.length?(f=a,l):f},l.decorate=function(a){return arguments.length?(g=a,l):g},l}function Ia(){var a=9,b=B,c=function(c){var d,e=2/(a+1),f=0;return c.map(function(c,g){if(a-1>g)return void(f+=b(c,g));if(g===a-1){f+=b(c,g);var h=f/a;return d=h,h}var i=b(c,g)*e+(1-e)*d;return d=i,i})};return c.windowSize=function(b){return arguments.length?(a=b,c):a},c.value=function(a){return arguments.length?(b=a,c):b},c}function Ja(){var b=B,c=function(a,b){return a.high},d=function(a,b){return a.low},e=Ia().windowSize(13),f=function(f){e.value(b);var g=e(f),h=a.zip(f,g).map(function(a){return{bullPower:a[1]?c(a[0])-a[1]:void 0,bearPower:a[1]?d(a[0])-a[1]:void 0}});return h};return f.value=function(a){return arguments.length?(b=a,f):b},f.highValue=function(a){return arguments.length?(c=a,f):c},f.lowValue=function(a){return arguments.length?(d=a,f):c},h(f,e,{period:"windowSize"}),f}function Ka(){var b=a.functor(void 0),c=a.functor(10),d=D,e=B,f=function(a){var f=c.apply(this,arguments),g=a.slice(0,f).map(e);return a.map(function(a,c){
...
function La(){var b=D,c=Ka(),d=function(d){return a.zip(d,c(d)).forEach(function(a){b(a[0],a[1])})};return d.algorithm=function(a){return arguments.length?(c=a,d):c},d.merge=function(a){return arguments.length?(b=a,d):b},d}function Ma(){var b=Ja().value(function(a){return a.close}),c=La().algorithm(b).merge(function(a,b){a.elderRay=b}),d=function(a){return c(a)};return a.rebind(d,c,"merge"),a.rebind(d,b,"highValue","lowValue","period","value"),d}function Na(){var b=.1,c=B,d=function(a){return a.map(function(a){return{lower:c(a)*(1-b),upper:c(a)*(1+b)}})};return d.factor=function(a){return arguments.length?(b=a,d):b},d.value=function(b){return arguments.length?(c=a.functor(b),d):c},d}
...
function Oa(){function b(a){return Array.apply(null,new Array(a)).map(d)}var c=Ka().accumulator(a.mean),d=a.functor(void 0),e=function(a){return null==c.value()(a)},f=function(a){for(var d=0;e(a[d])&&d<a.length;)d++;var f=a.slice(d);return b(d).concat(c(f))};return f.algorithm=function(a){return arguments.length?(c=a,f):c},f.undefinedValue=function(b){return arguments.length?(d=a.functor(b),f):d},f.defined=function(a){return arguments.length?(e=a,f):e},f}function Pa(){var b=Na(),c=Oa().undefinedValue({lower:void 0,upper:void 0}).algorithm(b),d=La().algorithm(c).merge(function(a,b){a.envelope=b}),e=function(a){return d(a)};return e.root=function(a){return a.envelope},a.rebind(e,d,"merge"),a.rebind(e,b,"value","factor"),e}function Qa(){var b=function(a,b){return a.volume},c=function(a,b){return a.close},d=Ka().windowSize(2).accumulator(function(a){return(c(a[1])-c(a[0]))*b(a[1])}),e=function(a){return d(a)};return e.volumeValue=function(a){return arguments.length?(b=a,e):b},e.closeValue=function(a){return arguments.length?(c=a,e):c},a.rebind(e,d,"windowSize"),e}function Ra(){var b=Qa(),c=La().algorithm(b).merge(function(a,b){a.force=b}),d=function(a){return c(a)};return a.rebind(d,c,"merge"),a.rebind(d,b,"windowSize","volumeValue","closeValue"),d}function Sa(){var b=function(a,b){return a.close},c=function(a,b){return a.high},d=function(a,b){return a.low},e=Ka().windowSize(5).accumulator(function(e){var f=a.max(e,c),g=a.min(e,d);return 100*(b(e[e.length-1])-g)/(f-g)}),f=Ka().windowSize(3).accumulator(function(b){return void 0!==b[0]?a.mean(b):void 0}),g=function(a){var b=e(a),c=f(b);return b.map(function(a,b){var d=c[b];return{k:a,d:d}})};return g.closeValue=function(a){return arguments.length?(b=a,g):b},g.highValue=function(a){return arguments.length?(c=a,g):c},g.lowValue=function(a){return arguments.length?(d=a,g):c},h(g,e,{kWindowSize:"windowSize"}),h(g,f,{dWindowSize:"windowSize"}),g}function Ta(){var b=Sa(),c=La().algorithm(b).merge(function(a,b){a.stochastic=b}),d=function(a){return c(a)};return a.rebind(d,c,"merge"),a.rebind(d,b,"kWindowSize","dWindowSize","lowValue","closeValue","highValue"),d}function Ua(){var b,c,d,e=function(a,b){return a.close},f=function(a,b){var c=b+(a[a.length-1]-b)/a.length;return c},g=function(a,b){return a+b},h=Ka().windowSize(14).accumulator(function(a){var h=a.map(e);if(!b)return void(b=h[0]);var i=[],j=[];h.forEach(function(a){var c=b>a?b-a:0,d=a>b?a-b:0;i.push(c),j.push(d),b=a});var k=c?f(i,c):i.reduce(g)/h.length,l=d?f(j,d):j.reduce(g)/h.length;c=k,d=l;var m=l/k;return 100-100/(1+m)}),i=function(a){return h(a)};return i.closeValue=function(a){return arguments.length?(e=a,i):e},a.rebind(i,h,"windowSize"),i}function Va(){var b=Ua(),c=La().algorithm(b).merge(function(a,b){a.rsi=b}),d=function(a){return c(a)};return a.rebind(d,c,"merge"),a.rebind(d,b,"windowSize","closeValue"),d}function Wa(){var b=Ka().accumulator(a.mean).value(function(a){return a.close}),c=La().algorithm(b).merge(function(a,b){a.movingAverage=b}),d=function(a){return c(a)};return a.rebind(d,c,"merge"),a.rebind(d,b,"windowSize","undefinedValue","value"),d}function Xa(){var b=B,c=Ia().windowSize(12),d=Ia().windowSize(29),e=Ia().windowSize(9),f=Oa().algorithm(e),g=function(e){c.value(b),d.value(b);var g=a.zip(c(e),d(e)).map(function(a){return void 0!==a[0]&&void 0!==a[1]?a[0]-a[1]:void 0}),h=f(g);return a.zip(g,h).map(function(a){return{macd:a[0],signal:a[1],divergence:void 0!==a[0]&&void 0!==a[1]?a[0]-a[1]:void 0}})};return g.value=function(a){return arguments.length?(b=a,g):b},h(g,c,{fastPeriod:"windowSize"}),h(g,d,{slowPeriod:"windowSize"}),h(g,e,{signalPeriod:"windowSize"}),g}function Ya(){var b=Xa().value(function(a){return a.close}),c=La().algorithm(b).merge(function(a,b){a.macd=b}),d=function(a){return c(a)};return a.rebind(d,c,"merge"),a.rebind(d,b,"fastPeriod","slowPeriod","signalPeriod","value"),d}function Za(){var b=Ia().value(function(a){return a.close}),c=La().algorithm(b).merge(function(a,b){a.exponentialMovingAverage=b}),d=function(a){return c(a)};return a.rebind(d,c,"merge"),a.rebind(d,b,"windowSize","value"),d}function $a(){var b=a.functor(0),c=B,d=function(a){if(0===a.length)return[];var d=c(a[b(a)]);return a.map(function(a,b){return(c(a,b)-d)/d})};return d.baseIndex=function(c){return arguments.length?(b=a.functor(c),d):b},d.value=function(a){return arguments.length?(c=a,d):c},d}function _a(){var b=2,c=Ka().undefinedValue({upper:void 0,average:void 0,lower:void 0}).accumulator(function(c){var d=a.mean(c),e=a.deviation(c);return{upper:d+b*e,average:d,lower:d-b*e}}),d=function(a){return c(a)};return d.multiplier=function(a){return arguments.length?(b=a,d):b},a.rebind(d,c,"windowSize","value"),d}function ab(){var b=_a().value(function(a){return a.close}),c=La().algorithm(b).merge(function(a,b){a.bollingerBands=b}),d=function(a){return c(a)};return d.root=function(a){return a.bollingerBands},a.rebind(d,c,"merge"),a.rebind(d,b,"windowSize","value","multiplier"),d}function bb(){var a=10,b=function(b){for(var c=Math.ceil(b.length/a),d=[],e=0;c>e;e++)d.push(b.slice(e*a,(e+1)*a));return d};return b.bucketSize=function(c){return arguments.length?(a=c,b):a},b}function cb(){function b(a){for(var b=a.map(function(a){return[d(a),e(a)]}),c=[],f=1;f<b.length-1;f++){var g=b[f-1],h=b[f],i=b[f+1],j=(g[0]-i[0])*(h[1]-g[1]),k=(g[0]-h[0])*(i[1]-g[1]),l=Math.abs(.5*j*k);c.push(l)}return c}var c=bb(),d=B,e=B,f=function(d){if(c.bucketSize()>=d.length)return d;var e=b(d),f=c(e),g=c(d.slice(1,d.length-1)),h=g.map(function(b,c){var d=f[c],e=a.max(d),g=d.indexOf(e);return b[g]});
// First and last data points are their own buckets.
return[].concat(d[0],h,d[d.length-1])};return a.rebind(f,c,"bucketSize"),f.x=function(a){return arguments.length?(d=a,f):d},f.y=function(a){return arguments.length?(e=a,f):e},f}function db(){var b=B,c=B,d=bb(),e=function(e){if(d.bucketSize()>=e.length)return e;var f=d(e.slice(1,e.length-1)),g=e[0],h=e[e.length-1],i=[].concat(g,f,h),j=b(g),k=c(g),l=f.map(function(d,e){for(var f,g=-(1/0),h=a.mean(i[e+1],b),l=a.mean(i[e+1],c),m=0;m<d.length;m++){var n=b(d[m]),o=c(d[m]),p=(j-h)*(o-k),q=(j-n)*(l-k),r=Math.abs(.5*p*q);r>g&&(g=r,f=d[m])}return j=b(f),k=c(f),f});
// First and last data points are their own buckets.
return[].concat(e[0],l,e[e.length-1])};return a.rebind(e,d,"bucketSize"),e.x=function(a){return arguments.length?(b=a,e):b},e.y=function(a){return arguments.length?(c=a,e):c},e}function eb(){var b=bb(),c=B,d=function(d){if(b.bucketSize()>d.length)return d;var e=a.extent(d),f=b(d.slice(1,d.length-1)),g=f.map(function(a,b){for(var d,f,g={},h=!0,i=0;i<a.length;i++){var j=c(a[i]);if(j===e[0]||j===e[1])return a[i];void 0===g[j]&&(g[j]=0),g[j]++,g[j]>g[d]||void 0===d?(d=j,f=i,h=!0):g[j]===g[d]&&(h=!1)}return h?a[f]:a[Math.floor(a.length/2)]});
// First and last data points are their own buckets.
...
function kb(){var b="BTC-USD",c=null,d=null,e=null,f=function(f){var g=[];null!=c&&g.push("start="+c.toISOString()),null!=d&&g.push("end="+d.toISOString()),null!=e&&g.push("granularity="+e);var h="https://api.exchange.coinbase.com/products/"+b+"/candles?"+g.join("&");a.json(h,function(a,b){return a?void f(a):(b=b.map(function(a){return{date:new Date(1e3*a[0]),open:a[3],high:a[2],low:a[1],close:a[4],volume:a[5]}}),void f(a,b))})};return f.product=function(a){return arguments.length?(b=a,f):b},f.start=function(a){return arguments.length?(c=a,f):c},f.end=function(a){return arguments.length?(d=a,f):d},f.granularity=function(a){return arguments.length?(e=a,f):e},f}function lb(b,c){function d(a){return E().selector("g."+a).element("g").attr("class",a)}b=b||a.scale.linear(),c=c||a.scale.linear();var e=10,f=9,g=D,h=ma(),i={bottom:30,right:30},k=function(a){return a.values},l=function(a){return a.key},m=ea().ticks(2),n=ea().orient("right").ticks(3),o=d("multiple"),p=d("x-axis"),q=d("y-axis"),r=function(d){d.each(function(d,j){function r(a,b){return{xOffset:(x+e)*a,yOffset:(y+e)*b}}var s=a.select(this),t=T(i);t.position="absolute";var u=s.selectAll("svg").data([d]);u.enter().append("svg").layout("flex",1).append("g").attr("class","multiples-chart");var v=u.select("g").layout(t);s.layout();var w=Math.ceil(d.length/f),x=v.layout("width")/f-e,y=v.layout("height")/w-e;H(b,[0,x]),H(c,[y,0]),h.xScale(b).yScale(c);
...
/tickFormat/];return j(r,b,"x",s),j(r,c,"y",s),j(r,m,"x"),j(r,n,"y"),r.columns=function(a){return arguments.length?(f=a,r):f},r.margin=function(a){return arguments.length?(i=a,r):i},r.padding=function(a){return arguments.length?(e=a,r):e},r.plotArea=function(a){return arguments.length?(h=a,r):h},r.values=function(a){return arguments.length?(k=a,r):k},r.key=function(a){return arguments.length?(l=a,r):l},r.decorate=function(a){return arguments.length?(g=a,r):g},r}function mb(){var b=50,c=D,d=[["datum:",function(a){return a.datum}]],e=E().selector("g.cell").element("g").attr("class","cell tooltip"),f=function(f){f.each(function(f,g){var h=a.select(this),i=d.map(function(b,c){return{datum:f,label:a.functor(b[0]),value:a.functor(b[1])}}),j=e(h,i);j.enter().layout({flex:1,flexDirection:"row"}),j.enter().append("text").attr("class","label").layout("flex",b),j.enter().append("text").attr("class","value").layout("flex",100-b),j.select(".label").text(function(a,b){return a.label.call(this,a.datum,b)}),j.select(".value").text(function(a,b){return a.value.call(this,a.datum,b)}),c(j,f,g),h.layout()})};return f.decorate=function(a){return arguments.length?(c=a,f):c},f.split=function(a){return arguments.length?(b=a,f):b},f.items=function(a){return arguments.length?(d=a,f):d},f}function nb(){
// creates an array with four elements, representing the high, low, open and close
// values of the given array
function b(b){function c(a){return b.filter(function(b){return e(b)===a})[0]}var d=j.xValue(),e=j.yValue(),f=a.max(b,e),g=a.min(b,e);return[{x:d(b[0]),y:e(b[0])},{x:d(c(f)),y:f},{x:d(c(g)),y:g},{x:d(b[b.length-1]),y:e(b[b.length-1])}]}var c=za(),d=a.scale.linear(),e=2,f=ma(),g=$().xValue(function(a){return a.x}).yValue(function(a){return a.y}).decorate(function(a){a.attr("class",function(a,b){switch(b){case 0:return"open";case 1:return"high";case 2:return"low";case 3:return"close"}})}),i=Y().series([f,g]).mapping(function(a){switch(a){case g:return b(this);default:return this}}),j=function(b){g.size(e*e*Math.PI),b.each(function(b){var f=a.select(this),g=Q(this),h=e;c.range([h,g.width-h]),d.range([g.height-h,h]),i.xScale(c).yScale(d),f.call(i)})};return h(j,c,{xDiscontinuityProvider:"discontinuityProvider",xDomain:"domain"}),h(j,d,{yDomain:"domain"}),h(j,f,"xValue","yValue"),j.xScale=function(){return c},j.yScale=function(){return d},j.radius=function(a){return arguments.length?(e=a,j):e},j}function ob(b,c){b=b||a.scale.linear(),c=c||a.scale.linear();var d={bottom:30,right:30},e="",f="",g=null,h=null,i="",k=ma(),l=D,m=va().orient("bottom").baseline(function(){if(null!==g)return c(g.apply(this,arguments));var a=G(c);return"bottom"===m.orient()?a[0]:a[1]}),n=va().orient("right").baseline(function(){if(null!==h)return b(h.apply(this,arguments));var a=G(b);return"left"===n.orient()?a[0]:a[1]}),o=E().selector("svg.cartesian-chart").element("svg").attr({"class":"cartesian-chart","layout-style":"flex: 1"}),p=function(g){g.each(function(g,h){var j=a.select(this),p=o(j,[g]);p.enter().html('<g class="plot-area-container">                     <rect class="background"                         layout-style="position: absolute; top: 0; bottom: 0; left: 0; right: 0"/>                     <g class="axes-container"                         layout-style="position: absolute; top: 0; bottom: 0; left: 0; right: 0">                         <g class="x-axis" layout-style="height: 0; width: 0"/>                         <g class="y-axis" layout-style="height: 0; width: 0"/>                     </g>                     <svg class="plot-area"                         layout-style="position: absolute; top: 0; bottom: 0; left: 0; right: 0"/>                 </g>                 <g class="x-axis label-container">                     <g layout-style="height: 0; width: 0">                         <text class="label"/>                     </g>                 </g>                 <g class="y-axis label-container">                     <g layout-style="height: 0; width: 0">                         <text class="label"/>                     </g>                 </g>                 <g class="title label-container">                     <g layout-style="height: 0; width: 0">                         <text class="label"/>                     </g>                 </g>');var q=T(d);p.select(".plot-area-container").layout({position:"absolute",top:q.top,left:q.left,bottom:q.bottom,right:q.right}),p.select(".title").layout({position:"absolute",top:0,alignItems:"center",left:q.left,right:q.right});var r={position:"absolute",top:q.top,bottom:q.bottom,alignItems:"center",flexDirection:"row"};r[n.orient()]=0,p.select(".y-axis.label-container").attr("class","y-axis label-container "+n.orient()).layout(r);var s={position:"absolute",left:q.left,right:q.right,alignItems:"center"};s[m.orient()]=0,p.select(".x-axis.label-container").attr("class","x-axis label-container "+m.orient()).layout(s),
...
// set the axis ranges
var t=p.select(".plot-area");H(b,[0,t.layout("width")]),H(c,[t.layout("height"),0]),
// render the axes
...
"xScale","yScale"];return j(p,m,"x",r),j(p,n,"y",r),p.xBaseline=function(b){return arguments.length?(g=a.functor(b),p):g},p.yBaseline=function(b){return arguments.length?(h=a.functor(b),p):h},p.chartLabel=function(a){return arguments.length?(i=a,p):i},p.plotArea=function(a){return arguments.length?(k=a,p):k},p.xLabel=function(a){return arguments.length?(f=a,p):f},p.margin=function(a){return arguments.length?(d=a,p):d},p.yLabel=function(a){return arguments.length?(e=a,p):e},p.decorate=function(a){return arguments.length?(l=a,p):l},p}function pb(){var b=a.time.scale(),c=a.scale.linear(),d=10,e=10,f=D,g=D,i=E().selector("line.x").element("line").attr("class","x gridline"),j=E().selector("line.y").element("line").attr("class","y gridline"),k=function(a){a.each(function(a,h){var k=b.ticks(d),l=i(this,k);l.attr({x1:b,x2:b,y1:c.range()[0],y2:c.range()[1]}),f(l,k,h);var m=c.ticks(e),n=j(this,m);n.attr({x1:b.range()[0],x2:b.range()[1],y1:c,y2:c}),g(n,m,h)})};return k.xScale=function(a){return arguments.length?(b=a,k):b},k.yScale=function(a){return arguments.length?(c=a,k):c},k.xTicks=function(a){return arguments.length?(d=a,k):d},k.yTicks=function(a){return arguments.length?(e=a,k):e},k.yDecorate=function(a){return arguments.length?(g=a,k):g},k.xDecorate=function(a){return arguments.length?(f=a,k):f},h(k,i,{xKey:"key"}),h(k,j,{yKey:"key"}),k}function qb(){var b,c,d,e,f=a.time.scale(),g=a.scale.linear(),h=function(){return G(f)[0]},i=function(){return G(f)[1]},j=function(){return G(g)[0]},k=function(){return G(g)[1]},l=D,m=E().selector("g.annotation").element("g").attr("class","annotation"),n=function(b){b.each(function(b,c){var d=a.select(this),e=m(d,b);e.enter().append("path").classed("band",!0);var f=da().horizontalAlign("right").verticalAlign("top").x(h).y(j).height(function(){return k.apply(this,arguments)-j.apply(this,arguments)}).width(function(){return i.apply(this,arguments)-h.apply(this,arguments)});e.select("path").attr("d",function(a,b){
// the path generator is being used to render a single path, hence
// an explicit index is provided
return f.call(this,[a],b)}),l(e,b,c)})};return n.xScale=function(a){return arguments.length?(f=a,n):f},n.yScale=function(a){return arguments.length?(g=a,n):g},n.decorate=function(a){return arguments.length?(l=a,n):l},n.x0=function(c){return arguments.length?(b=a.functor(c),h=function(){return f(b.apply(this,arguments))},n):b},n.x1=function(b){return arguments.length?(c=a.functor(b),i=function(){return f(c.apply(this,arguments))},n):c},n.y0=function(b){return arguments.length?(d=a.functor(b),j=function(){return g(d.apply(this,arguments))},n):d},n.y1=function(b){return arguments.length?(e=a.functor(b),k=function(){return g(e.apply(this,arguments))},n):e},n}function rb(a){for(;a.ownerSVGElement;)a=a.ownerSVGElement;return a}
// parses the style attribute, converting it into a JavaScript object
function sb(a){if(!a)return{};var b=a.split(";"),c={};return b.forEach(function(a){var b=a.split(":");if(2===b.length){var d=b[0].trim(),e=b[1].trim();c[d]=isNaN(e)?e:Number(e)}}),c}
// creates the structure required by the layout engine
function tb(a){function b(){for(var b=[],c=0;c<a.childNodes.length;c++){var d=a.childNodes[c];1===d.nodeType&&d.getAttribute("layout-style")&&b.push(tb(d))}return b}return{style:sb(a.getAttribute("layout-style")),children:b(a),element:a}}
...
!c&&b&&a.element.setAttribute("transform","translate("+a.layout.left+", "+a.layout.top+")"),a.children.forEach(function(a){ub(a,!0)})}function vb(a){return a.hasAttribute("layout-width")&&a.hasAttribute("layout-height")?{width:Number(a.getAttribute("layout-width")),height:Number(a.getAttribute("layout-height"))}:Q(a)}function wb(a){return a.hasAttribute("layout-x")&&a.hasAttribute("layout-y")?{x:Number(a.getAttribute("layout-x")),y:Number(a.getAttribute("layout-y"))}:{x:0,y:0}}function xb(a){if("suspended"!==rb(a).__layout__){var b=vb(a),c=wb(a),d=tb(a);
...
ub(d)}}function yb(a){return arguments.length?this.each(function(){rb(this).__layout__=a?"suspended":""}):Boolean(rb(this.node()).__layout__)}function zb(a,b){var c=arguments.length;
...
this.setAttribute("layout-width",a),this.setAttribute("layout-height",b),xb(this)):
...
var d=sb(this.getAttribute("layout-style")),e=a;Object.keys(e).forEach(function(a){d[a]=e[a]});var f=Object.keys(d).map(function(a){return a+":"+d[a]}).join(";");this.setAttribute("layout-style",f)}}else 0===c&&
// layout() - executes layout
xb(this)})}function Ab(b,c,d){arguments.length<3&&(d=1);var e=dd.util.extent().fields("date")(c),f=(e[1].getTime()-e[0].getTime())/1e3,g=b.map(function(a){return a.getTime()}),h=d*(a.max(g)-a.min(g))/1e3,i=f>h?[a.time.second.offset(e[1],-h),e[1]]:e;return i}function Bb(b,c){var d=a.min(b,function(a){return a.getTime()}),e=a.max(b,function(a){return a.getTime()}),f=c.sort(function(a,b){return a.date-b.date}),g=a.bisector(function(a){return a.date}),h=c.slice(
// Pad and clamp the bisector values to ensure extents can be calculated
Math.max(0,g.left(f,d)-1),Math.min(g.right(f,e)+1,f.length));return h}function Cb(b,c,d){var e=dd.util.extent().fields("date")(c),f=b.map(function(a){return a.getTime()}),g=(a.max(f)-a.min(f))/1e3;if(d.getTime()<e[0]||d.getTime()>e[1])return[new Date(a.min(f)),new Date(a.max(f))];var h=[a.time.second.offset(d,-g/2),a.time.second.offset(d,g/2)],i=0;return h[1].getTime()>e[1].getTime()?i=(e[1].getTime()-h[1].getTime())/1e3:h[0].getTime()<e[0].getTime()&&(i=(e[0].getTime()-h[0].getTime())/1e3),[a.time.second.offset(h[0],i),a.time.second.offset(h[1],i)]}function Db(a){return{id:fd.uid(),message:a}}function Eb(a,b,c,d){return{historicFeed:a,historicNotificationFormatter:b,streamingFeed:c,streamingNotificationFormatter:d}}function Fb(b,c,d,e,f,g){return{id:b,display:c||"Unspecified Product",priceFormat:a.format(g||".2f"),volumeFormat:a.format(f||".2f"),periods:d||[],source:e}}function Gb(b,c,d,e){return{display:b||"1 day",seconds:c||86400,d3TimeInterval:d||{unit:a.time.day,value:1},timeFormat:a.time.format(e||"%b %d")}}function Hb(a){return{viewDomain:[],period:a}}function Ib(a){return{data:[],viewDomain:[],trackingLatest:!0,product:a}}function Jb(){var b=dd.scale.dateTime(),c=a.scale.linear(),d=dd.util.fractionalBarWidth(.75),e=function(a,b){return a.date},f=function(a,c){return b(e(a,c))},g=function(a){return a.low},h=function(a){return a.high},i=function(a,b){return a.close},j=dd.svg.candlestick().x(function(a){return b(a.date)}).open(function(a){return c(a.open)}).high(function(a){return c(h(a))}).low(function(a){return c(g(a))}).close(function(a){return c(a.close)}),k=dd.util.dataJoin().selector("path.up").element("path").attr("class","up"),l=dd.util.dataJoin().selector("path.down").element("path").attr("class","down"),m=function(a){a.each(function(a){j.width(d(a.map(f)));var b=a.filter(function(a){return a.open<a.close}),c=a.filter(function(a){return a.open>=a.close});k(this,[b]).attr("d",j),l(this,[c]).attr("d",j)})};return m.xScale=function(a){return arguments.length?(b=a,m):b},m.yScale=function(a){return arguments.length?(c=a,m):c},m.xValue=function(a){return arguments.length?(e=a,m):e},m.yLowValue=function(a){return arguments.length?(g=a,m):g},m.yHighValue=function(a){return arguments.length?(h=a,m):h},m.yCloseValue=function(a){return arguments.length?(i=a,m):i},m.width=function(a){return d(a.map(f))},m}function Kb(a,b,c,d,e){return{displayString:a,// TODO: is 'displayName' better?
valueString:b,// TODO: is this an id?
option:c,// TODO: Ideally, remove.
isSelected:!1,icon:d,isPrimary:e}}function Lb(a){var b={data:[],trackingLatest:!0,viewDomain:[],selectorsChanged:!0},c=a;Object.defineProperty(b,"product",{get:function(){return c},set:function(a){c=a,b.selectorsChanged=!0}});var d=Jb();d.id=fd.uid();var e=Kb("Candlestick","candlestick",d);Object.defineProperty(b,"series",{get:function(){return e},set:function(a){e=a,b.selectorsChanged=!0}});var f={option:function(a){return a.close}};Object.defineProperty(b,"yValueAccessor",{get:function(){return f},set:function(a){f=a,b.selectorsChanged=!0}});var g=[];return Object.defineProperty(b,"indicators",{get:function(){return g},set:function(a){g=a,b.selectorsChanged=!0}}),b}function Mb(){return{trackingLatest:!0}}function Nb(){return{data:[],viewDomain:[],trackingLatest:!0}}function Ob(a,b){return{data:void 0,product:a,period:b}}function Pb(a,b){return{config:a,options:b}}function Qb(a,b,c,d){return{title:a||null,careted:b||!1,listIcons:c||!1,icon:d||!1}}function Rb(){return{primaryIndicators:[],secondaryIndicators:[]}}
// Generates a menu option similar to those generated by sc.model.menu.option from a sc.model.data.product object
function Sb(a){return{displayString:a.display,option:a}}
// Generates a menu option similar to those generated by model.menu.option from a model.data.period object
function Tb(a){return{displayString:a.display,option:a}}function Ub(a,b,c){return{productConfig:Qb(null,!0),mobilePeriodConfig:Qb(),products:a,selectedProduct:b,selectedPeriod:c,alertMessages:[]}}function Vb(b){function c(a){
// Don't pan off sides
// Don't pan off sides
return a[0]>=0?-a[0]:a[1]<=0?-a[1]:0}function d(a){
// If zooming, and about to pan off screen, do nothing
return a[0]>0&&a[1]<0}function e(a){var b=j.translate()[0];b+=a,j.translate([b,0])}function f(){j.translate([0,0]),j.scale(1)}function g(a){var g=dd.util.extent().fields("date")(a.datum().data);j.x(h).on("zoom",function(){var n=h(g[0]),o=h(g[1]),p=d([n,o-b]),q=c([n,o-b]);e(q);var r=1===j.scale(),s=1!==j.scale();if(r&&k||s&&l){var t=h.domain();p?t=g:s&&m&&(t=fd.domain.moveToLatest(t,a.datum().data)),t[0].getTime()!==t[1].getTime()?i.zoom(t):
// Ensure the user can't zoom-in infinitely, causing the chart to fail to render
// #168, #411
f()}else f()}),a.call(j)}var h,i=a.dispatch("zoom"),j=a.behavior.zoom(),k=!0,l=!0,m=!0;return g.allowPan=function(a){return arguments.length?(k=a,g):k},g.allowZoom=function(a){return arguments.length?(l=a,g):l},g.trackingLatest=function(a){return arguments.length?(m=a,g):m},g.scale=function(a){return arguments.length?(h=a,g):h},a.rebind(g,i,"on"),g}function Wb(){function b(b){b.each(function(f){var h=a.select(this).call(j),i=Vb(c).scale(e).trackingLatest(g).on("zoom",function(a){d[ld.viewChange](a)});h.select(".plot-area-container").datum({data:b.datum()}).call(i)})}var c,d=a.dispatch(ld.viewChange),e=dd.scale.dateTime(),f=a.scale.linear(),g=!0,h=60,i=dd.series.multi(),j=dd.chart.cartesian(e,f).plotArea(i).xTicks(0).yOrient("right").margin({top:0,left:0,bottom:0,right:h});return b.trackingLatest=function(a){return arguments.length?(g=a,b):g},a.rebind(b,d,"on"),a.rebind(b,i,"series","mapping","decorate"),a.rebind(b,j,"yTickValues","yTickFormat","yTicks","xDomain","yDomain"),b.dimensionChanged=function(a){c=parseInt(a.style("width"),10)-h},b}function Xb(){function b(a){a.each(function(b){var c=dd.util.extent().fields("volume").pad(.08)(b.data);c[0]<0&&(c[0]=0),e.yTickFormat(b.product.volumeFormat).trackingLatest(b.trackingLatest).xDomain(b.viewDomain).yDomain(c),a.datum(b.data).call(e)})}var c=a.dispatch(ld.viewChange),d=dd.series.bar().yValue(function(a){return a.volume}),e=Wb().series([d]).yTicks(4).on(ld.viewChange,function(a){c[ld.viewChange](a)});return a.rebind(b,c,"on"),b.dimensionChanged=function(a){e.dimensionChanged(a)},b}function Yb(){function b(a){var b=a.datum();e(b.data),g.trackingLatest(b.trackingLatest).xDomain(b.viewDomain).yDomain([0,100]),a.datum(b.data).call(g)}var c=a.dispatch(ld.viewChange),d=dd.indicator.renderer.relativeStrengthIndex(),e=dd.indicator.algorithm.relativeStrengthIndex(),f=[d.lowerValue(),50,d.upperValue()],g=Wb().series([d]).yTickValues(f).on(ld.viewChange,function(a){c[ld.viewChange](a)});return a.rebind(b,c,"on"),b.dimensionChanged=function(a){g.dimensionChanged(a)},b}function Zb(){function b(a){var b=a.datum();f(b.data);var c=dd.util.extent().fields("macd").symmetricalAbout(0).pad(.08)(b.data.map(function(a){return a.macd}));g.trackingLatest(b.trackingLatest).xDomain(b.viewDomain).yDomain(c),a.datum(b.data).call(g)}var c=a.dispatch(ld.viewChange),d=dd.annotation.line().value(0).label(""),e=dd.indicator.renderer.macd(),f=dd.indicator.algorithm.macd(),g=Wb().series([d,e]).yTicks(5).mapping(function(a){return a===d?[0]:this}).decorate(function(a){a.enter().attr("class",function(a,b){return["multi zero","multi"][b]})}).on(ld.viewChange,function(a){c[ld.viewChange](a)});return a.rebind(b,c,"on"),b.dimensionChanged=function(a){g.dimensionChanged(a)},b}function $b(){function b(a){var b=(d.ticks()[1]-d.ticks()[0])/1e3;b<a.seconds?e.ticks(a.d3TimeInterval.unit,a.d3TimeInterval.value):e.ticks(6)}function c(a){var c=a.datum();d.domain(c.viewDomain),b(c.period),a.call(e)}var d=dd.scale.dateTime(),e=a.svg.axis().scale(d).orient("bottom");return c.dimensionChanged=function(a){d.range([0,parseInt(a.style("width"),10)])},c}function _b(a,b){var c=b/2;return[[0,0],[c,-c],[a,-c],[a,c],[c,c],[0,0]]}function ac(a,b){for(var c=a.ticks.apply(a,[]),d=a.domain(),e=0;e<b.length;e++)b[e]>d[0]&&b[e]<d[1]&&c.push(b[e]);return c}function bc(b,c,d){var e;switch(c.valueString){case"candlestick":case"ohlc":e=[c.option.yLowValue(),c.option.yHighValue()];break;case"line":case"point":e=c.option.yValue();break;case"area":e=c.option.y1Value();break;default:throw new Error("Main series given to chart does not have expected interface")}var f=dd.util.extent().fields(e)(b);if(d.length){var g=d.map(function(a){return a.valueString}),h=-1!==g.indexOf("movingAverage"),i=-1!==g.indexOf("bollinger");if(i){var j=b.map(function(a){return a.bollingerBands}),k=dd.util.extent().fields(["lower","upper"])(j);f[0]=a.min([k[0],f[0]]),f[1]=a.max([k[1],f[1]])}if(h){var l=dd.util.extent().fields("movingAverage")(b);f[0]=a.min([l[0],f[0]]),f[1]=a.max([l[1],f[1]])}if(!h&&!i)throw new Error("Unexpected indicator type")}return f}function cc(){function b(){var a=[q,i.option,r],b=n.map(function(a){return a.option});return a.concat(b,p)}function c(){switch(w.value(m),x.value(m),r.value(m),i.valueString){case"line":case"point":case"area":i.option.yValue(m)}}
// Call when what to display on the chart is modified (ie series, options)
function d(a){i=a.series,m=a.yValueAccessor.option,n=a.indicators,c(),s.series(b()),v.yTickFormat(a.product.priceFormat),a.selectorsChanged=!1}function e(a){var b=i.option.width(a);p.decorate(function(a){a.classed("band hidden-xs hidden-sm",!0),a.selectAll(".vertical > line").style("stroke-width",b)})}function f(a){a.classed("band",!1).classed("hidden-xs hidden-sm",!0).selectAll("line").style("stroke-width",null)}function g(a){"candlestick"===i.valueString||"ohlc"===i.valueString?e(a):p.decorate(f)}function h(b){var c=b.datum();c.selectorsChanged&&d(c),v.xDomain(c.viewDomain),p.snap(dd.util.seriesPointSnapXOnly(i.option,c.data)),g(c.data),w(c.data),x(c.data);
// Scale y axis
var e=fd.domain.filterDataInDateRange(v.xDomain(),c.data),f=bc(e,i,n),h=fd.domain.padYDomain(f,.04);v.yDomain(h);
// Find current tick values and add close price to this list, then set it explicitly below
var o=m(c.data[c.data.length-1]),q=ac(u,[o]);v.yTickValues(q).yDecorate(function(b){b.selectAll(".tick").filter(function(a){return a===o}).classed("closeLine",!0).select("path").attr("d",function(b){return a.svg.area()(_b(k,14))})}),
// Redraw
v.plotArea(s),b.call(v);var r=Vb(j).scale(t).trackingLatest(c.trackingLatest).on("zoom",function(a){l[ld.viewChange](a)});b.select(".plot-area").call(r)}var i,j,k=60,l=a.dispatch(ld.viewChange,ld.crosshairChange),m=function(a){return a.close},n=[],o=[],p=dd.tool.crosshair().xLabel("").yLabel("").on("trackingmove",function(a){a.length>0?l.crosshairChange(a[0].datum):l.crosshairChange(void 0)}).on("trackingend",function(){l.crosshairChange(void 0)});p.id=fd.uid();var q=dd.annotation.gridline().yTicks(5).xTicks(0),r=dd.annotation.line().orient("horizontal").value(m).label("");r.id=fd.uid();var s=dd.series.multi().key(function(a){return a.id}).mapping(function(a){switch(a){case r:return[this.data[this.data.length-1]];case p:return o;default:return this.data}}),t=dd.scale.dateTime(),u=a.scale.linear(),v=dd.chart.cartesian(t,u).xTicks(0).yOrient("right").margin({top:0,left:0,bottom:0,right:k}),w=dd.indicator.algorithm.movingAverage(),x=dd.indicator.algorithm.bollingerBands();
// Call when the main layout is modified
return a.rebind(h,l,"on"),h.dimensionChanged=function(a){j=parseInt(a.style("width"),10)-k},h}function dc(){function b(a,b){a.select(".plot-area").selectAll(".e, .w").classed("hidden",b)}function c(a){return a.extent()[0][0]-a.extent()[1][0]===0}function d(a){var d=a.datum();q.domain(d.viewDomain);var f=fd.domain.filterDataInDateRange(dd.util.extent().fields("date")(d.data),d.data),g=dd.util.extent().fields(["low","high"])(f);p.xDomain(dd.util.extent().fields("date")(d.data)).yDomain(g),t.on("brush",function(){var d=c(t);
// Hide the bar if the extent is empty
b(a,d),d||o[ld.viewChange]([t.extent()[0][0],t.extent()[1][0]])}).on("brushend",function(){var e=c(t);b(a,!1),e&&o[ld.viewChange](fd.domain.centerOnDate(q.domain(),d.data,t.extent()[0][0]))}),p.plotArea(u),a.call(p);
// Allow to zoom using mouse, but disable panning
var h=Vb(e).scale(q).trackingLatest(d.trackingLatest).allowPan(!1).on("zoom",function(a){o[ld.viewChange](a)});a.select(".plot-area").call(h)}var e,f=100,g=40,h=f-g,i=2,j=i/2,k=h-j,l=k,m=j+l/2,n=2,o=a.dispatch(ld.viewChange),p=dd.chart.cartesian(dd.scale.dateTime(),a.scale.linear()).yTicks(0).margin({bottom:g}),q=dd.scale.dateTime(),r=dd.series.area().yValue(function(a){return a.close}),s=dd.series.line().yValue(function(a){return a.close}),t=a.svg.brush(),u=dd.series.multi().series([r,s,t]).decorate(function(a){var b=a.enter();a.select(".extent").attr("height",k).attr("y",i/2),
...
var c=b.selectAll(".e, .w");c.append("circle").attr("cy",m).attr("r",7).attr("class","outer-handle"),c.append("circle").attr("cy",m).attr("r",4).attr("class","inner-handle")}).mapping(function(a){return a!==t?this.data:void t.extent([[q.domain()[0],p.yDomain()[0]],[q.domain()[1],p.yDomain()[1]]])});return a.rebind(d,o,"on"),d.dimensionChanged=function(a){e=parseInt(a.style("width"),10),q.range([0,e])},d}function ec(){function b(b){b.each(function(b){var h=a.select(this);if(c=b.product.priceFormat,d=b.product.volumeFormat,e=b.period.timeFormat,null==b.data||b.data!==f){f=b.data;var i=h.selectAll("span").data(g);i.enter().append("span").attr("class",function(a,b){return b%2===0?"legendLabel":"legendValue"}),i.text(function(a,c){var d="";return c%2===0?a:b.data?a(b.data):d})}})}var c,d,e,f,g=["T",function(a){return e(a.date)},"O",function(a){return c(a.open)},"H",function(a){return c(a.high)},"L",function(a){return c(a.low)},"C",function(a){return c(a.close)},"V",function(a){return d(a.volume)}];return b}function fc(){function b(b){b.each(function(b){var d=a.select(this),e=d.selectAll("div").data(b.selectedIndicators,function(a){return a.valueString}),f=e.enter().append("div").attr("class","edit-indicator");f.append("span").attr("class","icon sc-icon-delete").on("click",c.indicatorChange),f.append("span").attr("class","indicator-label").text(function(a){return a.displayString}),e.exit().remove()})}var c=a.dispatch(ld.indicatorChange);return a.rebind(b,c,"on"),b}function gc(){var b=a.dispatch(ld.primaryChartIndicatorChange,ld.secondaryChartChange),c=fc().on(ld.indicatorChange,b[ld.primaryChartIndicatorChange]),d=fc().on(ld.indicatorChange,b[ld.secondaryChartChange]),e=function(b){b.each(function(b){var e=a.select(this);e.select("#overlay-primary-container .edit-indicator-container").datum({selectedIndicators:b.primaryIndicators}).call(c),e.selectAll(".overlay-secondary-container").each(function(c,e){var f=a.select(this),g=b.secondaryIndicators[e]?[b.secondaryIndicators[e]]:[];f.select(".edit-indicator-container").datum({selectedIndicators:g}).call(d)})})};return a.rebind(e,b,"on"),e}function hc(){function b(a){var b=a.datum(),d=a.selectAll("g").data([b]);d.enter().append("g").attr("class","reset-button").on("click",function(){c[ld.resetToLatest]()}).append("path").attr("d","M1.5 1.5h13.438L23 20.218 14.937 38H1.5l9.406-17.782L1.5 1.5z"),d.classed("active",!b.trackingLatest)}var c=a.dispatch(ld.resetToLatest);return a.rebind(b,c,"on"),b}function ic(){function b(a){var b=a.datum(),h=b.selectedIndex||0,i=b.config,j=d(a,[b.options]);if(i.icon){var k=j.selectAll(".icon").data([0]);k.enter().append("span"),k.attr("class","icon "+b.options[h].icon)}else j.select(".icon").remove(),j.text(function(){return i.title||b.options[h].displayString});e(j,i.careted?[0]:[]);var l=f(a,[b.options]),m=g(l,b.options),n=m.enter().on("click",c.optionChange).append("a").attr("href","#");n.append("span").attr("class","icon"),n.append("span").attr("class","name"),m.selectAll(".icon").attr("class",function(a){return"icon "+a.icon}),m.selectAll(".name").text(function(a){return a.displayString})}var c=a.dispatch("optionChange"),d=dd.util.dataJoin().selector("button").element("button").attr({"class":"dropdown-toggle",type:"button","data-toggle":"dropdown"}),e=dd.util.dataJoin().selector(".caret").element("span").attr("class","caret"),f=dd.util.dataJoin().selector("ul").element("ul").attr("class","dropdown-menu"),g=dd.util.dataJoin().selector("li").element("li").key(function(a){return a.displayString});return a.rebind(b,c,"on"),b}function jc(){var b=a.dispatch(ld.primaryChartSeriesChange,ld.primaryChartIndicatorChange,ld.secondaryChartChange),c=ic().on("optionChange",b[ld.primaryChartSeriesChange]),d=ic().on("optionChange",function(a){a.isPrimary?b[ld.primaryChartIndicatorChange](a):b[ld.secondaryChartChange](a)}),e=function(b){b.each(function(b){var e=a.select(this),f=b.seriesSelector.options.map(function(a){return a.isSelected}).indexOf(!0);e.select("#series-dropdown").datum({config:b.seriesSelector.config,options:b.seriesSelector.options,selectedIndex:f}).call(c);var g=b.indicatorSelector.options,h=g.map(function(a,b){return a.isSelected?b:null}).filter(function(a){return a});e.select("#indicator-dropdown").datum({config:b.indicatorSelector.config,options:g,selected:h}).call(d)})};return a.rebind(e,b,"on"),e}function kc(){function b(a){var b=a.datum().selectedIndex||0,e=d(a,[a.datum().options]);e.enter().append("ul");var f=e.selectAll("li").data(dd.util.fn.identity);f.enter().append("li").append("a").attr("href","#").on("click",c.tabClick),f.classed("active",function(a,c){return c===b}).select("a").text(function(a){return a.displayString}),f.exit().remove()}var c=a.dispatch("tabClick"),d=dd.util.dataJoin().selector("ul").element("ul");return a.rebind(b,c,"on"),b}function lc(){var b=a.dispatch(ld.dataProductChange,ld.dataPeriodChange,ld.clearAllPrimaryChartIndicatorsAndSecondaryCharts),c=ic().on("optionChange",b[ld.dataProductChange]),d=kc().on("tabClick",b[ld.dataPeriodChange]),e=ic().on("optionChange",b[ld.dataPeriodChange]),f=function(f){f.each(function(f){var g=a.select(this),h=f.products;g.select("#product-dropdown").datum({config:f.productConfig,options:h.map(Sb),selectedIndex:h.indexOf(f.selectedProduct)}).call(c);var i=f.selectedProduct.periods;g.select("#period-selector").classed("hidden",i.length<=1).datum({options:i.map(Tb),selectedIndex:i.indexOf(f.selectedPeriod)}).call(d),g.select("#mobile-period-selector").classed("hidden",i.length<=1).datum({config:f.mobilePeriodConfig,options:i.map(Tb),selectedIndex:i.indexOf(f.selectedPeriod)}).call(e),g.select("#clear-indicators").on("click",b[ld.clearAllPrimaryChartIndicatorsAndSecondaryCharts])})};return a.rebind(f,b,"on"),f}function mc(){function a(a){var c=++b;return function(d,e){b>c||a(d,e)}}var b=0;return a.invalidateCallback=function(){return b++,a},a}function nc(){function b(a){var b=1e3*f;return new Date(Math.floor(a.getTime()/b)*b)}var c=function(a){return a.date},d=function(a){return Number(a.volume)},e=function(a){return Number(a.price)},f=60,g=function(f,g){var h=b(c(g)),i=e(g),j=d(g),k=a.bisector(function(a){return a.date}).left,l=f.filter(function(a){return a.date.getTime()===h.getTime()})[0];l?(l.high=Math.max(i,l.high),l.low=Math.min(i,l.low),l.close=i,l.volume+=j):f.splice(k(f,h),0,{date:h,open:i,high:i,low:i,close:i,volume:j})};return g.granularity=function(a){return arguments.length?(f=a,g):f},g.price=function(a){return arguments.length?(e=a,g):e},g.volume=function(a){return arguments.length?(d=a,g):d},g.date=function(a){return arguments.length?(c=a,g):c},g}function oc(){function b(){f&&f.streamingFeed&&f.streamingFeed.close(),k=[],i.invalidateCallback()}function c(a){return a.sort(function(a,b){return a.date-b.date})}function d(){null!=f.streamingFeed&&(f.streamingFeed.on("message",function(a){h(k,a),g[ld.newTrade](k,f)}).on("error",function(a){g[ld.streamingFeedError](a,f)}).on("close",function(a){g[ld.streamingFeedClose](a,f)}),f.streamingFeed())}function e(a,e){b(),2===arguments.length&&(f=e.source,f.historicFeed.product(e.id),null!=f.streamingFeed&&f.streamingFeed.product(e.id));var l=new Date;f.historicFeed.end(l).candles(j).granularity(a),h.granularity(a),f.historicFeed(i(function(a,b){a?g[ld.historicFeedError](a,f):(k=c(b),g[ld.historicDataLoaded](k,f),d())}))}var f,g=a.dispatch(ld.newTrade,ld.historicDataLoaded,ld.historicFeedError,ld.streamingFeedError,ld.streamingFeedClose),h=nc().date(function(a){return new Date(a.time)}).volume(function(a){return Number(a.size)}),i=mc(),j=200,k=[];return a.rebind(e,g,"on"),e}function pc(b){a.json("https://api.exchange.coinbase.com/products",function(a,c){return a?void b(a):void b(a,c)})}function qc(a,b,c,d){return a.map(function(a){return kd.data.product(a.id,a.id,d.get(a.id)||c,b)})}function rc(){var b=a.dispatch(ld.notificationClose),c=dd.util.dataJoin().selector("div.alert-content").element("div").attr("class","alert-content"),d=dd.util.dataJoin().selector("div.alert").element("div").attr({"class":"alert alert-info alert-dismissible",role:"alert"}).key(function(a){return a.id}),e=function(e){e.each(function(e){var f=a.select(this),g=c(f,[e]);g.enter().html('<div class="messages"></div>');var h=d(g.select(".messages"),e.messages),i=h.enter();i.html('<button type="button" class="close" aria-label="Close">                     <span aria-hidden="true">&times;</span>                 </button>                 <span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span>                 <span class="sr-only">Error:</span>                 <span class="message"></span>'),i.select(".close").on("click",function(a){b[ld.notificationClose](a.id)}),h.select(".message").text(function(a){return a.message})})};return a.rebind(e,b,"on"),e}function sc(a){var b;if(a.wasClean===!1&&1e3!==a.code&&1006!==a.code){var c=a.reason||"Unkown reason.";b="Disconnected from live stream: "+a.code+" "+c}return b}function tc(a){var b;
// The WebSocket's error event doesn't contain much useful information,
// so the close event is used to report errors instead
return"error"===a.type&&a.message?b="Live stream error: "+a.message:"close"===a.type&&(b=sc(a)),b}function uc(b){function c(){ca&&N.suspendLayout(!1),N.primary.datum(S).call(aa.primary),N.legend.datum(Z).call(aa.legend),N.secondaries.datum(T).filter(function(a,b){return b<aa.secondaries.length}).each(function(b,c){a.select(this).attr("class","secondary-container "+aa.secondaries[c].valueString).call(aa.secondaries[c].option)}),N.xAxis.datum(V).call(aa.xAxis),N.navbar.datum(W).call(aa.navbar),N.app.select("#navbar-reset").datum(X).call(G),N.app.select(".head-menu").datum(Y).call(F),N.app.select("#selectors").datum(U).call(H),N.app.select("#notifications").datum(_).call(I),N.overlay.datum($).call(M),ca&&(N.suspendLayout(!0),ca=!1)}function d(){ca=!0,fd.layout(N,aa)}function e(){a.select(window).on("resize",function(){d(),ba()})}function f(a){_.messages.unshift(Db(a))}function g(a){var b=[a[0],a[1]];S.viewDomain=b,T.viewDomain=b,V.viewDomain=b,W.viewDomain=b;var c=fd.domain.trackingLatestData(S.viewDomain,S.data);S.trackingLatest=c,T.trackingLatest=c,W.trackingLatest=c,X.trackingLatest=c,ba()}function h(a){a.isSelected=!a.isSelected,A(),ba()}function i(a){a.isSelected=!a.isSelected,B(),ba()}function j(a){Z.data=a,ba()}function k(a,b){var c;c=b.streamingNotificationFormatter?b.streamingNotificationFormatter(a):tc(a),c&&(f(c),ba())}function l(){var a=S.data,b=dd.util.extent().fields("date")(a),c=fd.domain.moveToLatest(b,a,.2);g(c)}function m(a,b){K.select("#loading-status-message").classed("hidden",!(a||b)).select(".content").text(b||"Loading..."),K.select("#charts").classed("hidden",a||b)}function n(a){S.data=a,T.data=a,W.data=a}function o(a){Y.selectedProduct=a,S.product=a,T.product=a,Z.product=a}function p(a){Y.selectedPeriod=a,V.period=a,Z.period=a}function q(){return nd.primary().on(ld.crosshairChange,j).on(ld.viewChange,g)}function r(){return nd.nav().on(ld.viewChange,g)}function s(){return od.navigationReset().on(ld.resetToLatest,l)}function t(){return oc().on(ld.newTrade,function(a,b){if(n(a),S.trackingLatest){var c=fd.domain.moveToLatest(S.viewDomain,S.data);g(c)}}).on(ld.historicDataLoaded,function(a,b){m(!1),n(a),Z.data=null,l(),d()}).on(ld.historicFeedError,function(a,b){m(!1,"Error loading data. Please make your selection again, or refresh the page.");var c="";try{var d=JSON.parse(a.responseText),e=b.historicNotificationFormatter(d);e&&(c=". "+e)}catch(g){c=""}var h=a.statusText||"Unknown reason.",i="Error getting historic data: "+h+c;f(i),ba()}).on(ld.streamingFeedError,k).on(ld.streamingFeedClose,k)}function u(a){return od.head().on(ld.dataProductChange,function(b){m(!0),o(b.option),p(b.option.periods[0]),a(b.option.periods[0].seconds,b.option),ba()}).on(ld.dataPeriodChange,function(b){m(!0),p(b.option),a(b.option.seconds),ba()}).on(ld.clearAllPrimaryChartIndicatorsAndSecondaryCharts,function(){S.indicators.forEach(w),aa.secondaries.forEach(w),A(),B(),ba()})}function v(a,b){b.forEach(function(a){a.isSelected=!1}),a.isSelected=!0}function w(a){a.isSelected=!1}function x(){pc(y)}function y(b,c){if(b){var d=b.statusText||"Unknown reason.",e="Error retrieving Coinbase products: "+d;f(e)}else{var g=[P.hour1,P.day1],h=a.map();h.set("BTC-USD",[P.minute1,P.minute5,P.hour1,P.day1]);var i=qc(c,Q.bitcoin,g,h);Y.products=Y.products.concat(i)}ba()}function z(){return od.selectors().on(ld.primaryChartSeriesChange,function(a){S.series=a,v(a,U.seriesSelector.options),ba()}).on(ld.primaryChartIndicatorChange,h).on(ld.secondaryChartChange,i)}function A(){S.indicators=U.indicatorSelector.options.filter(function(a){return a.isSelected&&a.isPrimary}),$.primaryIndicators=S.indicators}function B(){aa.secondaries=U.indicatorSelector.options.filter(function(a){return a.isSelected&&!a.isPrimary}),
// TODO: This doesn't seem to be a concern of menu.
aa.secondaries.forEach(function(a){a.option.on(ld.viewChange,g)}),$.secondaryIndicators=aa.secondaries,
// TODO: Remove .remove! (could a secondary chart group component manage this?).
N.secondaries.selectAll("*").remove(),d()}function C(){return od.overlay().on(ld.primaryChartIndicatorChange,h).on(ld.secondaryChartChange,i)}function D(a){_.messages=_.messages.filter(function(b){return b.id!==a}),ba()}function E(){return pd.toast().on(ld.notificationClose,D)}var F,G,H,I,J={},K=a.select("#app-container"),L=K.select("#charts-container"),M=K.select("#overlay"),N={app:K,charts:L,primary:L.select("#primary-container"),secondaries:L.selectAll(".secondary-container"),xAxis:L.select("#x-axis-container"),navbar:L.select("#navbar-container"),overlay:M,overlaySecondaries:M.selectAll(".overlay-secondary-container"),legend:K.select("#legend"),suspendLayout:function(a){var b=this;Object.keys(b).forEach(function(c){"function"!=typeof b[c]&&b[c].layoutSuspended(a)})}},O=b,P=O.periods,Q=O.sources,R=O.products,S=O.primaryChart,T=O.secondaryChart,U=O.selectors,V=O.xAxis,W=O.nav,X=O.navReset,Y=O.headMenu,Z=O.legend,$=O.overlay,_=O.notificationMessages,aa={primary:void 0,secondaries:[],xAxis:nd.xAxis(),navbar:void 0,legend:nd.legend()},ba=dd.util.render(c),ca=!0;return J.run=function(){aa.primary=q(),aa.navbar=r();var a=t();F=u(a),G=s(),H=z(),M=C(),I=E(),d(),e(),a(R.generated.periods[0].seconds,R.generated),x()},J}function vc(){var a,b,c,d=dd.data.random.financial(),e=[86400],f=null,g=function(c){b.setHours(0,0,0,0);var e=864e5;d.startDate(new Date(b-(a-1)*e));var f=d(a);c(null,f)};return g.candles=function(b){return arguments.length?(a=b,g):a},g.end=function(a){return arguments.length?(b=a,g):b},g.granularity=function(a){if(!arguments.length)return c;if(-1===e.indexOf(a))throw new Error("Granularity of "+a+" is not supported. Random Financial Data Generator only supports daily data.");return c=a,g},g.product=function(a){if(!arguments.length)return g;if(null!==a)throw new Error("Random Financial Data Generator does not support products.");return f=a,g},g}
// Inspired by underscore library implementation of debounce
function wc(a,b,c){var d,e,f,g,h=function(){var i=(new Date).getTime()-f;b>i&&i>=0?d=setTimeout(h.bind(this),b-i):(d=null,c||(g=a.apply(this,e),e=null))};return function(){e=arguments,f=(new Date).getTime();var i=c&&!d;return d||(d=setTimeout(h.bind(this),b)),i&&(g=a.apply(this,e),e=null),g}}function xc(){var b,c=1e3,d=dd.data.feed.coinbase(),e=wc(function(c){var e=a.time.second.offset(d.end(),-b*d.granularity());d.start(e),d(c)},c);return e.candles=function(a){return arguments.length?(b=a,e):b},a.rebind(e,d,"end","granularity","product"),e}function yc(a){var b;return a&&(b=a.message),b}
...
!b||b.readyState!==WebSocket.CONNECTING&&b.readyState!==WebSocket.OPEN||b.close()},f.messageType=function(a){return arguments.length?(e=a,f):e},f.product=function(a){return arguments.length?(c=a,f):c},f}function Ac(){function b(b){var g=a.time.second.offset(e.end(),-d*c);e.start(g).collapse(f.get(c)),e(b)}var c,d,e=dd.data.feed.quandl(),f=a.map();return f.set(86400,"daily"),f.set(604800,"weekly"),b.candles=function(a){return arguments.length?(d=a,b):d},b.granularity=function(a){if(!arguments.length)return c;if(!f.has(a))throw new Error("Granularity of "+a+" is not supported.");return c=a,b},dd.util.rebind(b,e,{end:"end",product:"dataset"}),b}function Bc(a){var b;return a&&a.quandl_error&&(b=a.quandl_error.message),b}function Cc(){function b(){return{week1:kd.data.period("Weekly",604800,{unit:a.time.week,value:1},"%b %d"),day1:kd.data.period("Daily",86400,{unit:a.time.day,value:1},"%b %d"),hour1:kd.data.period("1 Hr",3600,{unit:a.time.hour,value:1},"%b %d %Hh"),minute5:kd.data.period("5 Min",300,{unit:a.time.minute,value:5},"%H:%M"),minute1:kd.data.period("1 Min",60,{unit:a.time.minute,value:1},"%H:%M")}}function c(){return{generated:kd.data.source(vc(),null,null),bitcoin:kd.data.source(xc(),yc,zc(),tc),quandl:kd.data.source(Ac(),Bc,null,null)}}function d(){return{generated:kd.data.product(null,"Data Generator",[i.day1],j.generated,".3s"),quandl:kd.data.product("GOOG","GOOG",[i.day1,i.week1],j.quandl,".3s")}}function e(){var a=Jb();a.id=fd.uid();var b=kd.menu.option("Candlestick","candlestick",a,"sc-icon-candlestick-series");b.isSelected=!0;var c=dd.series.ohlc();c.id=fd.uid();var d=dd.series.line();d.id=fd.uid();var e=dd.series.point();e.id=fd.uid();var f=dd.series.area();f.id=fd.uid();var g=kd.menu.dropdownConfig(null,!1,!0,!0),h=[b,kd.menu.option("OHLC","ohlc",c,"sc-icon-ohlc-series"),kd.menu.option("Line","line",d,"sc-icon-line-series"),kd.menu.option("Point","point",e,"sc-icon-point-series"),kd.menu.option("Area","area",f,"sc-icon-area-series")];return kd.menu.selector(g,h)}function f(){var a=nd.secondary,b=dd.series.line().decorate(function(a){a.enter().classed("movingAverage",!0)}).yValue(function(a){return a.movingAverage});b.id=fd.uid();var c=dd.indicator.renderer.bollingerBands();c.id=fd.uid();var d=[kd.menu.option("Moving Average","movingAverage",b,"sc-icon-moving-average-indicator",!0),kd.menu.option("Bollinger Bands","bollinger",c,"sc-icon-bollinger-bands-indicator",!0),kd.menu.option("Relative Strength Index","secondary-rsi",a.rsi(),"sc-icon-rsi-indicator",!1),kd.menu.option("MACD","secondary-macd",a.macd(),"sc-icon-macd-indicator",!1),kd.menu.option("Volume","secondary-volume",a.volume(),"sc-icon-bar-series",!1)];return d}function g(){var a=kd.menu.dropdownConfig("Add Indicator",!1,!0);return kd.menu.selector(a,f())}function h(){return{seriesSelector:e(),indicatorSelector:g()}}var i=b(),j=c(),k=d();return{periods:i,sources:j,products:k,primaryChart:kd.chart.primary(k.generated),secondaryChart:kd.chart.secondary(k.generated),selectors:h(),xAxis:kd.chart.xAxis(i.day1),nav:kd.chart.nav(),navReset:kd.chart.navigationReset(),headMenu:kd.menu.head([k.generated,k.quandl],k.generated,i.day1),legend:kd.chart.legend(k.generated,i.day1),overlay:kd.menu.overlay(),notificationMessages:kd.notification.messages()}}a="default"in a?a["default"]:a;var Dc=0,Ec=!1,Fc=Object.freeze({randomItem:t,randomIndex:u,cloneAndReplace:v}),Gc={boundingBox:z,greedy:y,local:x,annealing:w},Hc=Object.freeze({context:A,identity:B,index:C,noop:D}),Ic=1e-6,Jc=Object.freeze({isOrdinal:F,range:G,setRange:H}),Kc={rectangles:J,strategy:Gc},Lc={dataJoin:E,expandRect:T,extent:S,fn:Hc,minimum:k,fractionalBarWidth:R,innerDimensions:Q,rebind:h,rebindAll:j,scale:Jc,noSnap:L,pointSnap:M,seriesPointSnap:N,seriesPointSnapXOnly:O,seriesPointSnapYOnly:P,render:K,arrayFunctor:I,array:Fc},Mc={crosshair:_,fibonacciFan:W,container:V,measure:U},Nc={axis:ea,bar:da,candlestick:ca,ohlc:ba,errorBar:aa},Oc={waterfall:fa},Pc={area:ra,bar:pa,stack:na,line:oa},Qc={area:qa,axis:va,bar:ga,candlestick:ua,cycle:ta,line:ma,multi:Y,ohlc:sa,point:$,stacked:Pc,groupedBar:la,xyBase:Z,ohlcBase:ka,errorBar:ja,waterfall:ha,algorithm:Oc};za.tickTransformer=xa;var Rc={discontinuity:{identity:wa,skipWeekends:Aa},dateTime:za},Sc={bollingerBands:Ha,macd:Ga,relativeStrengthIndex:Fa,stochasticOscillator:Ea,forceIndex:Da,envelope:Ca,elderRay:Ba},Tc={bollingerBands:_a,exponentialMovingAverage:Ia,macd:Xa,percentageChange:$a,relativeStrengthIndex:Ua,stochasticOscillator:Sa,slidingWindow:Ka,undefinedInputAdapter:Oa,forceIndex:Qa,envelope:Na,elderRay:Ja},Uc={bollingerBands:ab,calculator:Tc,exponentialMovingAverage:Za,macd:Ya,merge:La,movingAverage:Wa,relativeStrengthIndex:Va,stochasticOscillator:Ta,forceIndex:Ra,envelope:Pa,elderRay:Ma},Vc={algorithm:Uc,renderer:Sc},Wc={modeMedian:eb,largestTriangleThreeBucket:db,largestTriangleOneBucket:cb,bucket:bb},Xc={filter:{skipWeekends:ib},financial:hb,walk:gb},Yc={coinbase:kb,quandl:jb},Zc={feed:Yc,random:Xc,spread:fb,sampler:Wc};/**
...
sXML="<svg xmlns='http://www.w3.org/2000/svg'>"+a+"</svg>";for(var c=b.parseFromString(sXML,"text/xml").documentElement,d=c.firstChild;d;)this.appendChild(this.ownerDocument.importNode(d,!0)),d=d.nextSibling}catch(e){throw new Error("Error parsing XML string")}}})}}((1,eval)("this").SVGElement);var $c={cartesian:ob,sparkline:nb,tooltip:mb,smallMultiples:lb},_c={band:qb,gridline:pb,line:X},ad=b(function(a,b){
...
c.fillNodes(a),c.computeLayout(a)}})}),bd=ad&&"object"==typeof ad&&"default"in ad?ad["default"]:ad;a.selection.prototype.layoutSuspended=yb,a.transition.prototype.layoutSuspended=yb,a.selection.prototype.layout=zb,a.transition.prototype.layout=zb;
// Needs to be defined like this so that the grunt task can update it
var cd="development",dd={annotation:_c,chart:$c,data:Zc,indicator:Vc,scale:Rc,series:Qc,svg:Nc,tool:Mc,util:Lc,version:cd,layout:Kc},ed={centerOnDate:Cb,filterDataInDateRange:Bb,moveToLatest:Ab,padYDomain:g,trackingLatestData:f},fd={domain:ed,layout:e,uid:d},gd={message:Db,messages:c},hd={period:Gb,product:Fb,source:Eb},id={legend:Ob,nav:Nb,navigationReset:Mb,primary:Lb,secondary:Ib,xAxis:Hb},jd={head:Ub,periodAdaptor:Tb,productAdaptor:Sb,overlay:Rb,dropdownConfig:Qb,option:Kb,selector:Pb},kd={menu:jd,chart:id,data:hd,notification:gd},ld={crosshairChange:"crosshairChange",viewChange:"viewChange",newTrade:"newTrade",historicDataLoaded:"historicDataLoaded",historicFeedError:"historicFeedError",streamingFeedError:"streamingFeedError",streamingFeedClose:"streamingFeedClose",dataProductChange:"dataProductChange",dataPeriodChange:"dataPeriodChange",resetToLatest:"resetToLatest",clearAllPrimaryChartIndicatorsAndSecondaryCharts:"clearAllPrimaryChartIndicatorsAndSecondaryCharts",primaryChartSeriesChange:"primaryChartSeriesChange",primaryChartYValueAccessorChange:"primaryChartYValueAccessorChange",primaryChartIndicatorChange:"primaryChartIndicatorChange",secondaryChartChange:"secondaryChartChange",indicatorChange:"indicatorChange",notificationClose:"notificationClose"},md={base:Wb,macd:Zb,rsi:Yb,volume:Xb},nd={legend:ec,nav:dc,primary:cc,xAxis:$b,secondary:md},od={head:lc,selectors:jc,navigationReset:hc,overlay:gc},pd={toast:rc},qd=Cc();uc(qd).run()});