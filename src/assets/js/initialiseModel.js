...
export default function() {
    ...
    return {
        periods: periods,
        sources: sources,
        primaryChart: model.chart.primary(products.generated, periods.day1),
        secondaryChart: model.chart.secondary(products.generated, periods.day1),
        selectors: initSelectors(periods.day1),
        xAxis: model.chart.xAxis(periods.day1),
        nav: model.chart.nav(periods.day1),
